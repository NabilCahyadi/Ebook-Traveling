...
class LandingPageContentController extends Controller
{
    ...
    public function editTopCities()
    {
        ...
        return view('admin.landing-page-content.top-cities', compact('section', 'allCities', 'selectedCities'));
    }
    ...
    public function editLatestBlogs()
    {
        ...
        return view('admin.landing-page-content.latest-blogs', compact('section', 'allBlogs', 'selectedBlogs', 'displayCount'));
    }
