...
class CategoryController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        return view('admin.ebook-management.categories.index', compact('categories'));
    }
    ...
    {
        return view('admin.ebook-management.categories.create');
    }
    ...
    public function trashed()
    {
        try {
            ...
            return view('admin.ebook-management.categories.trashed', compact('categories'));
        } catch (\Exception $e) {
            return redirect()->route('admin.categories.index')
