...
class EbookRatingController extends Controller
{
    ...
    public function index(string $ebookId)
    {
        ...
        return view('admin.ebook-management.ebooks.ratings.index', compact('ebook', 'ratings', 'stats'));
    }
    ...
    public function create(string $ebookId)
    {
        ...
        return view('admin.ebook-management.ebooks.ratings.create', compact('ebook', 'users'));
    }
    ...
    public function edit(string $ebookId, string $ratingId)
    {
        ...
        return view('admin.ebook-management.ebooks.ratings.edit', compact('ebook', 'rating', 'users'));
    }
