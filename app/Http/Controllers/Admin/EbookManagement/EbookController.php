...
namespace App\Http\Controllers\Admin\EbookManagement;
...
class EbookController extends Controller
{
    ...
    public function store(Request $request)
    {
        try {
            $validated = $request->validate([
                ...
                'description' => 'required|string|min:47',
                ...
                'description.min' => 'Deskripsi ebook minimal 47 karakter.',
    ...
    public function show($id)
    {
        ...
        return view('admin.ebook-management.ebooks.show', compact('ebook'));
    }
    ...
    public function trash(Request $request)
    {
        try {
            ...
            return view('admin.ebook-management.ebooks.trash', compact('ebooks'));
        } catch (\Exception $e) {
    ...
    public function pendingApproval()
    {
        ...
        return view('admin.ebook-management.ebooks.pending-approval', compact('ebooks'));
    }
    ...
    public function bulkRestore(Request $request)
    {
        ...
        try {
            $count = \App\Models\Ebook::withTrashed()
                ->whereIn('id', $validated['ids'])
                ->restore();

            return redirect()->back()
                ->with('success', "{$count} ebook(s) restored successfully!");
        } catch (\Exception $e) {
            return redirect()->back()
                ->with('error', 'Failed to restore ebooks: ' . $e->getMessage());
        }
    }
    ...
    public function bulkForceDelete(Request $request)
    {
        ...
        try {
            $ebooks = \App\Models\Ebook::withTrashed()->whereIn('id', $validated['ids'])->get();
            $count = 0;
            ...
            return redirect()->back()
                ->with('success', "{$count} ebook(s) permanently deleted!");
        } catch (\Exception $e) {
            return redirect()->back()
                ->with('error', 'Failed to delete ebooks: ' . $e->getMessage());
        }
