...
class CityController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        return view('admin.ebook-management.cities.index', compact('cities', 'provinces'));
    }
    ...
    {
        return view('admin.ebook-management.cities.create');
    }
    ...
    public function show(string $id)
    {
        ...
        return view('admin.ebook-management.cities.show', compact('city'));
    }
    ...
    {
        $city = City::findOrFail($id);
        return view('admin.ebook-management.cities.edit', compact('city'));
    }
