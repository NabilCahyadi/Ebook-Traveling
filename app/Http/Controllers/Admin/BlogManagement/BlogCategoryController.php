...
class BlogCategoryController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        return view('admin.blog-management.categories.index', compact('categories', 'search'));
    }
    ...
    {
        return view('admin.blog-management.categories.create');
    }
    ...
    public function show(string $id)
    {
        ...
        return view('admin.blog-management.categories.show', compact('category'));
    }
    ...
    {
        $category = Category::where('type', 'blog')->findOrFail($id);
        return view('admin.blog-management.categories.edit', compact('category'));
    }
    ...
    public function trashed(Request $request)
    {
        ...
        return view('admin.blog-management.categories.trashed', compact('categories', 'search'));
    }
