...
class UserController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        return view('admin.user-management.users.index', compact('users', 'roleSlug', 'userType', 'search', 'showTrashed', 'roles', 'googleId', 'registered'));
    }
    ...
    public function create(Request $request)
    {
        try {
            ...
            return view('admin.user-management.users.create', compact('roleSlug'));
        } catch (\Exception $e) {
            return redirect()->route('admin.users.index')
    ...
    public function trashed(Request $request)
    {
        ...
        return view('admin.user-management.users.trashed', compact('users', 'search'));
    }
    ...
    /**
     * Bulk delete users (move to trash).
     */
    public function bulkDelete(Request $request)
    {
        ...
        try {
            ...
            return redirect()->route('admin.users.index')
                ->with('success', __('admin.users.users_deleted_successfully') . " ({$count} users)");
        } catch (\Exception $e) {
