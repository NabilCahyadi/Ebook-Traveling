...
class PricingBenefitController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('admin.website-management.about-us.benefits.index', compact('benefits'));
    }
    ...
    {
        return view('admin.website-management.about-us.benefits.create');
    }
    ...
    public function edit($id)
    {
        ...
        return view('admin.website-management.about-us.benefits.edit', compact('benefit'));
    }
