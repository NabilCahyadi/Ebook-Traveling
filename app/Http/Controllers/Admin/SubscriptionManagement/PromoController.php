...
class PromoController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        return view('admin.subscription-management.promos.index', compact('promos'));
    }
    ...
    public function create()
    {
        ...
        return view('admin.subscription-management.promos.create', compact('subscriptionPlans'));
    }
    ...
    public function edit($id)
    {
        ...
        return view('admin.subscription-management.promos.edit', compact('promo', 'subscriptionPlans'));
    }
