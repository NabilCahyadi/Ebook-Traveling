...
class SubscriptionPlanController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        return view('admin.subscription-management.plans.index', compact('plans', 'activeCategory'));
    }
    ...
    {
        return view('admin.subscription-management.plans.create');
    }
    ...
    public function show(string $id)
    {
        ...
        return view('admin.subscription-management.plans.show', compact('plan'));
    }
    ...
    public function edit(string $id)
    {
        ...
        return view('admin.subscription-management.plans.edit', compact('plan', 'durationValue'));
    }
    ...
    public function trashed()
    {
        try {
            ...
            return view('admin.subscription-management.plans.trashed', compact('plans'));
        } catch (\Exception $e) {
            return redirect()->route('admin.subscription-plans.index')
