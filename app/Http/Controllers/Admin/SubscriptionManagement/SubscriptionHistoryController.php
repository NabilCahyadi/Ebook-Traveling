...
class SubscriptionHistoryController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        return view('admin.subscription-management.history.index', compact('subscriptions', 'stats'));
    }
    ...
    public function show(string $id)
    {
        ...
        return view('admin.subscription-management.history.show', compact('subscription'));
    }
    ...
    public function print($id)
    {
        ...
        return view('admin.subscription-management.history.print', compact('subscription'));
    }
}
