...
class ManualSubscriptionController extends Controller
{
    ...
    public function create()
    {
        ...
        return view('admin.subscription-management.manual-subscriptions.create', compact('plans', 'users'));
    }
    ...
    public function show(string $id)
    {
        try {
            ...
            return view('admin.subscription-management.manual-subscriptions.show', compact('subscription'));
        } catch (\Exception $e) {
            return redirect()->route('admin.manual-subscriptions.index')
                ->with('error', $e->getMessage());
        }
    ...
    public function extend(string $id)
    {
        try {
            ...
            $plans = $this->subscriptionService->getActivePlans();
            return view('admin.subscription-management.manual-subscriptions.extend', compact('subscription', 'plans'));
        } catch (\Exception $e) {
            return redirect()->route('admin.manual-subscriptions.index')
                ->with('error', $e->getMessage());
        }
    ...
    public function showPaymentLinkForm()
    {
        ...
        return view('admin.subscription-management.manual-subscriptions.payment-link', compact('plans', 'users'));
    }
    ...
    public function showPaymentLink(string $id)
    {
        try {
            ...
            return view('admin.subscription-management.manual-subscriptions.payment-link-detail', compact('paymentLink'));
        } catch (\Exception $e) {
            return redirect()->route('admin.manual-subscriptions.index')
    ...
    public function paymentLinks(Request $request)
    {
        ...
        return view('admin.subscription-management.manual-subscriptions.payment-links-list', compact('paymentLinks', 'search'));
    }
