...
class ContactInfoController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('admin.website-management.contact-info.index', compact('contacts'));
    }
    ...
    {
        return view('admin.website-management.contact-info.show', compact('contactInfo'));
    }
    ...
    {
        return view('admin.website-management.contact-info.edit', compact('contactInfo'));
    }
