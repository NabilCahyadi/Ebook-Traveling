...
class BannerController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        if ($activeTab === 'banner-pricing') {
            ...
            return view('admin.website-management.banners.index', compact('activeTab', 'bannerPricing'));
        }
        ...
        return view('admin.website-management.banners.index', compact('banners', 'activeTab'));
    }
    ...
    public function create()
    {
        ...
        return view('admin.website-management.banners.create', compact('hasBannerPricing'));
    }
    ...
    {
        return view('admin.website-management.banners.show', compact('banner'));
    }
    ...
    {
        return view('admin.website-management.banners.edit', compact('banner'));
    }
