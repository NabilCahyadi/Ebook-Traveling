...
class CollectionController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('admin.website-management.collections.index', compact('collections'));
    }
    ...
    {
        return view('admin.website-management.collections.create');
    }
    ...
    public function show(string $id)
    {
        ...
        return view('admin.website-management.collections.show', compact('collection'));
    }
    ...
    public function edit(string $id)
    {
        ...
        return view('admin.website-management.collections.edit', compact('collection'));
    }
