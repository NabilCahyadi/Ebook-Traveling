...
class PolicyController extends Controller
{
    ...
    protected function indexPageType($pageType, Request $request)
    {
        ...
        return view('admin.website-management.policies.index', compact('sections', 'pageTypeName', 'pageTypeSlug'));
    }
    ...
    protected function createPageType($pageType)
    {
        ...
        return view('admin.website-management.policies.create', compact('nextOrder', 'pageTypeName', 'pageTypeSlug'));
    }
    ...
    protected function editPageType($pageType, string $id)
    {
        ...
        return view('admin.website-management.policies.edit', compact('section', 'pageTypeName', 'pageTypeSlug'));
    }
