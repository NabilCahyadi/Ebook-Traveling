                                    ...
                                    <div class="comment-list">
                                        ...
                                        <div class="single-comment mb-30">
                                            <div class="review-header">
                                                ...
                                                <div class="review-date">{{ $rating->created_at->format('F d, Y \a\t g:i A') }}</div>
                                            </div>
                            ...
                            <div class="col-lg-4">
                                <div class="rating-container">
                                    ...
                                    <div class="d-flex mb-30">
                                        ...
                                        <!-- <h6>{{ number_format($ebook->average_rating, 1) }} out of 5</h6> -->
                                    </div>

                                    <div class="progress">
                                        <span>5 star</span>
                                        <div class="progress-bar" role="progressbar" style="width: {{ ($ebook->total_reviews > 0) ? ($ratingDistribution[5] / $ebook->total_reviews) * 100 : 0 }}%" aria-valuenow="{{ ($ebook->total_reviews > 0) ? ($ratingDistribution[5] / $ebook->total_reviews) * 100 : 0 }}" aria-valuemin="0" aria-valuemax="100">{{ ($ebook->total_reviews > 0) ? number_format(($ratingDistribution[5] / $ebook->total_reviews) * 100) : 0 }}%</div>
                                    </div>
                                    <div class="progress">
                                        <span>4 star</span>
