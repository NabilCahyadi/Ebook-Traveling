    ...
    @endif -->
                                                        ...
                                                        <div class="product-content-wrap">
                                                            <h2 style="margin-top:15px;"><a
                                                                    href="/ebook/{{ $ebook->slug }}">{{ Str::limit($ebook->title, 40) }}</a>
                                                            </h2>
                                                                ...
                                                                <div class="product-rate-cover">
                                                                    <div class="product-rate d-inline-block">
                                                                        <div class="product-rating"
                                                                            style="width: {{ ($ebook->average_rating / 5) * 100 }}%">
                                                                        </div>
                                                                    </div>
                                                                    <span
                                                                        class="font-small ml-5 text-muted">({{ $ebook->average_rating }})</span>
                                                                </div>
                                                                <div class="read-count">
                                                                    <i class="fi-rs-eye mt-5"></i>
                                                                    {{ number_format($ebook->read_count) }}
                                                                </div>
                                                            </div>
                                    ...
                                    <a href="{{ route('blogs.show', $blog->slug) }}">
                                        @if ($blog->featured_image)
                                            <img class="border-radius-15"
                                                ...
                                                alt="{{ $blog->title }}" />
                                        @else
                                            <img class="border-radius-15" src="{{ asset('images/blogs/default.webp') }}"
                                                alt="{{ $blog->title }}" />
                                        @endif
                                    </a>
                                </div>
                                <div class="entry-content-2">
                                    @if ($blog->category)
                                        <h6 class="mb-10 font-sm">
                                            <a class="entry-meta text-muted" href="#">{{ $blog->category }}</a>
                                        </h6>
                                    @endif
                                    <h4 class="post-title mb-15">
                                        <a
                                            href="{{ route('blogs.show', $blog->slug) }}">{{ Str::limit($blog->title, 80) }}</a>
                                    </h4>
                                    <div class="entry-meta font-xs color-grey mt-10 pb-10">
                                        <div>
                                            <span
                                                class="post-on mr-10">{{ $blog->published_at ? $blog->published_at->format('d M Y') : $blog->created_at->format('d M Y') }}</span>
                                            <span class="hit-count has-dot mr-10">{{ number_format($blog->view_count) }}
                                                Views</span>
