                    ...
                    <div class="row">
                        <div class="col-lg-4 col-md-6 mb-24">
                            <div class="featured-card">
                                <img src="assets-nest/nest-fe/imgs/theme/icons/icon-1.svg" alt="" />
                        ...
                        <div class="col-lg-4 col-md-6 mb-24">
                            <div class="featured-card">
                                <img src="assets-nest/nest-fe/imgs/theme/icons/icon-2.svg" alt="" />
                        ...
                        <div class="col-lg-4 col-md-6 mb-24">
                            <div class="featured-card">
                                <img src="assets-nest/nest-fe/imgs/theme/icons/icon-3.svg" alt="" />
                                <h4>Free Delivery</h4>
                                <p>There are many variations of passages of Lorem Ipsum available, but the majority have suffered alteration in some form</p>
                                <a href="#">Read more</a>
                            </div>
                        ...
                        <div class="col-lg-4 col-md-6 mb-24">
                            <div class="featured-card">
                                <img src="assets-nest/nest-fe/imgs/theme/icons/icon-4.svg" alt="" />
                                <h4>Easy Returns</h4>
                                <p>There are many variations of passages of Lorem Ipsum available, but the majority have suffered alteration in some form</p>
                                <a href="#">Read more</a>
                            </div>
                        ...
                        <div class="col-lg-4 col-md-6 mb-24">
                            <div class="featured-card">
                                <img src="assets-nest/nest-fe/imgs/theme/icons/icon-5.svg" alt="" />
                        ...
                        <div class="col-lg-4 col-md-6 mb-24">
                            <div class="featured-card">
                                <img src="assets-nest/nest-fe/imgs/theme/icons/icon-6.svg" alt="" />
                                    ...
                                    <div class="team-card">
                                        ...
                                        <div class="content text-center">
                                            ...
                                            <div class="social-network mt-20">
                                                <a href="#"><img src="assets-nest/imgs/theme/icons/icon-facebook-brand.svg" alt="" /></a>
                                                <a href="#"><img src="assets-nest/imgs/theme/icons/icon-twitter-brand.svg" alt="" /></a>
                                                <a href="#"><img src="assets-nest/imgs/theme/icons/icon-instagram-brand.svg" alt="" /></a>
                                                <a href="#"><img src="assets-nest/imgs/theme/icons/icon-youtube-brand.svg" alt="" /></a>
                                            </div>
                                        </div>
                                    </div>
                                </div>
