...
@section('content')
    ...
    <div class="card mb-4">
        <div class="card-body">
            <form method="GET" action="{{ route('admin.admin-activity-logs.index') }}" id="filterForm">
                <div class="row g-3">
                    <!-- Admin Filter -->
                    <div class="col-md-3">
    ...
    <div class="card">
        <div class="card-header d-flex justify-content-between align-items-center">
            ...
            <div class="text-muted">Total: {{ $logs->total() }} logs</div>
        </div>
        <div class="card-body">
            @if ($logs->count() > 0)
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <small class="text-muted">
                                            ...
                                            <br>
                                            <span class="text-primary">{{ $log->created_at->diffForHumans() }}</span>
                                        </small>
                                    </td>
                                    <td>
                                        <a href="{{ route('admin.admin-activity-logs.show', $log->id) }}"
    ...
    <div class="modal fade" id="cleanupModal" tabindex="-1" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <form action="{{ route('admin.admin-activity-logs.cleanup') }}" method="POST">
                    @csrf
                    @method('DELETE')
...
@push('scripts')
    <script>
        function exportLogs() {
            ...
            window.location.href = '{{ route('admin.admin-activity-logs.export') }}?' + params;
        }
    </script>
@endpush
