            ...
            <div class="d-flex gap-2">
                @if (!($showTrashed ?? false))
                    <button type="button" class="btn btn-outline-secondary btn-sm" id="toggleBulkMode"
                        ...
                        <i class="ti ti-checkbox me-1"></i> {{ __('admin.users.select_multiple') }}
                    </button>
                @endif
        ...
        <div id="bulkActionsBar" class="mx-3 mt-3 p-3 bg-light rounded d-none">
            <div class="d-flex align-items-center justify-content-between flex-wrap gap-2">
                <div class="d-flex align-items-center">
                    <span class="me-3"><strong id="selectedCount">0</strong> {{ __('admin.users.item_selected') }}</span>
                </div>
                <div class="d-flex gap-2 flex-wrap">
                    <!-- Delete Button -->
                    <button type="button" class="btn btn-sm btn-outline-danger" onclick="bulkDelete()">
                        <i class="ti ti-trash me-1"></i> {{ __('admin.users.move_to_trash') }}
                    </button>
                </div>
            </div>
        </div>
    ...
    @push('scripts')
        <script>
            ...
            window.bulkDelete = function () {
                ...
                const message = '{{ __("admin.users.bulk_delete_confirm", ["count" => ":count"]) }}'.replace(':count', ids.length);
                if (confirm(message)) {
