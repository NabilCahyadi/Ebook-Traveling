...
@section('title', __('admin.reports.user_analytics'))
...
@section('content')
    <div class="container-xxl flex-grow-1 container-p-y">
            ...
            <div>
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb breadcrumb-style1 mb-2">
                        ...
                        <li class="breadcrumb-item active">{{ __('admin.reports.user_analytics') }}</li>
                    </ol>
                </nav>
                <h4 class="mb-1">{{ __('admin.reports.user_analytics') }}</h4>
        ...
        <div class="card mb-4">
            <div class="card-body">
                <form method="GET" action="{{ route('admin.reports.user-analytics') }}" class="row g-3">
                    <div class="col-md-3">
                    ...
                    <div class="col-md-3 d-flex align-items-end">
                        ...
                        <a href="{{ route('admin.reports.user-analytics') }}" class="btn btn-outline-secondary">
        ...
        <div class="row g-4 mb-4">
            <div class="col-md-3">
                <div class="card">
                    <div class="card-body text-center">
                        <h3 class="text-primary mb-2">{{ number_format($totalUsers) }}</h3>
            ...
            <div class="col-md-3">
                <div class="card">
                    <div class="card-body text-center">
                        <h3 class="text-success mb-2">{{ number_format($activeUsers) }}</h3>
            ...
            <div class="col-md-3">
                <div class="card">
                    <div class="card-body text-center">
                        <h3 class="text-warning mb-2">{{ number_format($inactiveUsers) }}</h3>
            ...
            <div class="col-md-3">
                <div class="card">
                    <div class="card-body text-center">
                        <h3 class="text-info mb-2">{{ number_format($premiumUsers) }}</h3>
...
@push('scripts')
    ...
    <script>
        ...
        let userGrowthChart = new Chart(userGrowthCtx, {
            type: 'line',
            data: {
                labels: {!! json_encode($userGrowth->pluck('date')->map(fn($date) => \Carbon\Carbon::parse($date)->format('d M'))) !!},
                datasets: [{
                    label: 'New Users',
