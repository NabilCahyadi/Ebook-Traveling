...
@section('title', __('admin.subscription_history.payment_detail'))
    ...
    <div class="container-xxl flex-grow-1 container-p-y">
        ...
        <div class="d-flex justify-content-between align-items-center mb-4">
            <h4 class="fw-bold py-3 mb-0">
                <span class="text-muted fw-light">{{ __('admin.subscription_history.title') }} /</span> {{ __('admin.common.details') }}
            </h4>
            <a href="{{ route('admin.subscription-history.index') }}" class="btn btn-secondary">
                <i class="ti ti-arrow-left me-1"></i> {{ __('admin.subscription_history.back_to_history') }}
            </a>
        </div>
            ...
            <div class="col-lg-8 mb-4">
                <div class="card mb-4">
                    ...
                    <div class="card-body">
                        <div class="row mb-3">
                            <div class="col-md-4">
                                <small class="text-muted">{{ __('admin.manual_subscription.code') }}</small>
                            ...
                            <div class="col-md-4">
                                <small class="text-muted">{{ __('admin.subscription_history.auto_renew') }}</small>
                                <p class="mb-0">
                        ...
                        <div class="row mb-3">
                            <div class="col-md-6">
                                <small class="text-muted">{{ __('admin.manual_subscription.plan') }}</small>
                                <p class="mb-0 fw-semibold">{{ $subscription->plan->name }}</p>
                                <small class="text-muted">{{ $subscription->plan->description }}</small>
                            </div>
                            <div class="col-md-6">
                                <small class="text-muted">{{ __('admin.manual_subscription.total_amount') }}</small>
                        ...
                        <div class="row mb-3">
                            <div class="col-md-6">
                                <small class="text-muted">{{ __('admin.subscriptions.start_date') }}</small>
                                <p class="mb-0">{{ $subscription->start_date->format('d F Y, H:i') }}</p>
                            </div>
                            <div class="col-md-6">
                                <small class="text-muted">{{ __('admin.subscriptions.end_date') }}</small>
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <small class="text-muted">{{ __('admin.common.created_at') }}</small>
                                <p class="mb-0">{{ $subscription->created_at->format('d F Y, H:i') }}</p>
                            </div>
                            <div class="col-md-6">
                                <small class="text-muted">{{ __('admin.common.updated_at') }}</small>
                ...
                @if ($subscription->payment)
                    <div class="card">
                        <div class="card-header">
                            <h5 class="mb-0">{{ __('admin.subscription_history.payment_information') }}</h5>
                        </div>
                        <div class="card-body">
                            <div class="row mb-3">
                                <div class="col-md-6">
                                    <small class="text-muted">{{ __('admin.subscription_history.transaction_id') }}</small>
                                    <p class="mb-0 fw-semibold">{{ $subscription->payment->transaction_id ?? '-' }}</p>
                                </div>
                                <div class="col-md-6">
                                    <small class="text-muted">{{ __('admin.subscription_history.payment_method') }}</small>
                            ...
                            <div class="row mb-3">
                                <div class="col-md-6">
                                    <small class="text-muted">{{ __('admin.subscription_history.payment_status') }}</small>
                                    <div>
