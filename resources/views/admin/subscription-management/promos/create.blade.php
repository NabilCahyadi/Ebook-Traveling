...
@section('title', __('admin.promos.create_promo'))
...
@section('content')
    <div class="container-fluid">
        ...
        <div class="d-flex justify-content-between align-items-center mb-4">
            <div>
                <h4 class="mb-1">{{ __('admin.promos.create_promo') }}</h4>
                <p class="text-muted mb-0">{{ __('admin.promos.create_description') }}</p>
            </div>
        ...
        @if ($errors->any())
            <div class="alert alert-danger alert-dismissible fade show" role="alert">
                <strong>{{ __('admin.messages.validation_error') }}</strong>
                <ul class="mb-0">
