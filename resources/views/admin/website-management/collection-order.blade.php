...
@section('title', 'Manage Collection Order')
                    ...
                    <table class="table table-borderless">
                        ...
                        <tbody id="sortable-collections">
                            @foreach ($collections as $index => $collection)
                                <tr data-id="{{ $collection->id }}" data-order="{{ $collection->order }}"
                                    ...
                                    <td>
                                        <div class="d-flex align-items-center">
                                            <div>
                                                ...
                                                <small class="text-muted">{{ $collection->slug }}</small>
                                            </div>
                                        </div>
                                    </td>
                                    <td>
                                    ...
                                    <td>
                                        <div class="form-check form-switch">
                                            <input class="form-check-input visibility-toggle" type="checkbox"
                                                ...
                                                {{ $collection->is_visible_on_landing ? 'checked' : '' }}>
                                            <label class="form-check-label">
                                                <span class="visibility-text">
                                                    {{ $collection->is_visible_on_landing ? 'Visible' : 'Hidden' }}
                                                </span>
                                            </label>
                                        </div>
                                    </td>
        ...
        document.addEventListener('DOMContentLoaded', function() {
            ...
            if (saveButton) {
                saveButton.addEventListener('click', function() {
                    ...
                    fetch("{{ route('admin.collection-order.update') }}", {
                            method: 'POST',
                            headers: {
