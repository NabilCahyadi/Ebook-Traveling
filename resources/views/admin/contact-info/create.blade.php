                ...
                <div class="row">
                    ...
                    <div class="col-md-6 mb-3">
                        ...
                        <select class="form-select @error('contact_type') is-invalid @enderror" 
                            ...
                            <option value="instagram" {{ old('contact_type') == 'instagram' ? 'selected' : '' }}>Instagram</option>
                            <option value="facebook" {{ old('contact_type') == 'facebook' ? 'selected' : '' }}>Facebook</option>
                            <option value="twitter" {{ old('contact_type') == 'twitter' ? 'selected' : '' }}>Twitter/X</option>
                            <option value="address" {{ old('contact_type') == 'address' ? 'selected' : '' }}>Address</option>
                            <option value="linkedin" {{ old('contact_type') == 'linkedin' ? 'selected' : '' }}>LinkedIn</option>
                            <option value="youtube" {{ old('contact_type') == 'youtube' ? 'selected' : '' }}>YouTube</option>
                    ...
                    <div class="col-md-6 mb-3">
                        <div class="form-check">
                            <input class="form-check-input" 
                                   ...
                                   {{ old('show_in_contact_page') ? 'checked' : '' }}>
