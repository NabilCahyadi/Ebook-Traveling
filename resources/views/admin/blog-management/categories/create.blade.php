...
@section('title', __('admin.blog_categories.create_category'))
...
@section('content')
    ...
    <div class="d-flex justify-content-between align-items-center mb-4">
        <div>
            <h4 class="fw-bold py-3 mb-2">
                <span class="text-muted fw-light">{{ __('admin.menu.admin') }} / {{ __('admin.menu.content_management') }} / {{ __('admin.blog_categories.blog_categories') }} /</span> {{ __('admin.blog_categories.create') }}
            </h4>
        </div>
        <div>
    ...
    <div class="card">
        <div class="card-header">
            <h5 class="mb-0">{{ __('admin.blog_categories.create_new_category') }}</h5>
        </div>
        <div class="card-body">
            <form action="{{ route('admin.blog-categories.store') }}" method="POST">
                        ...
                        <div class="card bg-light">
                            <div class="card-body">
                                ...
                                <div class="alert alert-info mb-0">
                                    ...
                                    <small>{{ __('admin.blog_categories.slug_auto_generate') }}</small>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="mt-4">
                    <button type="submit" class="btn btn-primary">
                        <i class="ti ti-check me-1"></i> {{ __('admin.blog_categories.create_category') }}
                    </button>
                    <a href="{{ route('admin.blog-categories.index') }}" class="btn btn-secondary">
