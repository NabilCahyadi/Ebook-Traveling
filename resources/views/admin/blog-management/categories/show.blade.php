    ...
    <div class="d-flex justify-content-between align-items-center mb-4">
        <div>
            <h4 class="fw-bold py-3 mb-2">
                <span class="text-muted fw-light">{{ __('admin.menu.admin') }} / {{ __('admin.menu.content_management') }} / {{ __('admin.blog_categories.blog_categories') }} /</span> {{ __('admin.blog_categories.details') }}
            </h4>
        </div>
        <div>
