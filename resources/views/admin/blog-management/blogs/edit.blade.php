    ...
    <div class="container-xxl flex-grow-1 container-p-y">
        <div class="d-flex justify-content-between align-items-center mb-4">
            <h4 class="fw-bold py-3 mb-0">
                <span class="text-muted fw-light">{{ __('admin.menu.admin') }} / {{ __('admin.blogs.title') }} /</span> {{ __('admin.blogs.edit') }}
            </h4>
                    ...
                    <div class="card mb-4">
                        ...
                        <div class="card-body">
                            <div class="mb-3">
                                ...
                                <select class="form-select @error('status') is-invalid @enderror" id="status"
                                    ...
                                    <option value="scheduled"
                                        {{ old('status', $blog->status) == 'scheduled' ? 'selected' : '' }}>{{ __('admin.status.scheduled') }}
                                    </option>
                            ...
                            <div class="mb-3" id="scheduledDateContainer" style="{{ old('status', $blog->status) == 'scheduled' ? '' : 'display: none;' }}">
                                <label class="form-label" for="published_at"><i class="ti ti-calendar-time me-1"></i> {{ __('admin.blogs.publish_date_time') }} <span class="text-danger" id="published_at_required">*</span></label>
                                ...
                                @error('published_at')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                                <div class="form-text">{{ __('admin.blogs.scheduled_help') }}</div>
                            </div>
        ...
        <script>
            ...
            try {
                ...
                if (tagsValue) {
                    ...
                    // Convert to simple array of strings if needed
                    if (Array.isArray(parsed)) {
                        existingTags = parsed.map(tag => {
                            // If tag is already an object with value property, extract it
            ...
            // Clear the input value before initializing Tagify
            tagsInput.value = '';
            ...
            // Add existing tags (as simple strings, Tagify will convert them)
