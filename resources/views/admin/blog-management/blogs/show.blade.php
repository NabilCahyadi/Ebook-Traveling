    ...
    <div class="container-xxl flex-grow-1 container-p-y">
        <div class="d-flex justify-content-between align-items-center mb-4">
            <h4 class="fw-bold py-3 mb-0">
                <span class="text-muted fw-light">{{ __('admin.menu.admin') }} / {{ __('admin.blogs.title') }} /</span> {{ __('admin.blogs.details') }}
            </h4>
            <div>
                        ...
                        <div class="d-flex justify-content-between align-items-start mb-3">
                            <div>
                                ...
                                <div class="text-muted mb-2">
                                    <i class="bx bx-user me-1"></i> {{ $blog->author->name ?? __('admin.common.unknown') }}
                            ...
                            @if ($blog->status === 'published')
                                <span class="badge bg-success">{{ __('admin.status.published') }}</span>
                            @elseif($blog->status === 'draft')
                                <span class="badge bg-warning">{{ __('admin.status.draft') }}</span>
                            ...
                            @elseif($blog->status === 'unpublished')
                                <span class="badge bg-secondary">{{ __('admin.status.unpublished') }}</span>
                            @else
                                <span class="badge bg-danger">{{ $blog->status ?: __('admin.common.unknown') }}</span>
                            @endif
                        </div>
