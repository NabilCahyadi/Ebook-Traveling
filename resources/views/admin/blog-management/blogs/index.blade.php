                    ...
                    <div class="col-12 col-md-9">
                        <div class="d-flex gap-2 justify-content-end align-items-center flex-wrap">
                            ...
                            <select class="form-select form-select-sm" id="status" onchange="applyBlogFilters()" style="width: 130px;">
                                ...
                                <option value="scheduled" {{ $status == 'scheduled' ? 'selected' : '' }}>{{ __('admin.status.scheduled') }}</option>
                        ...
                        <div class="d-flex gap-2 flex-wrap">
                            ...
                            <div class="dropdown">
                                ...
                                <ul class="dropdown-menu">
                                    <li><a class="dropdown-item" href="#" onclick="bulkChangeStatus('draft')"><i class="ti ti-pencil me-2 text-warning"></i>{{ __('admin.status.draft') }}</a></li>
                                    <li><a class="dropdown-item" href="#" onclick="bulkChangeStatus('published')"><i class="ti ti-check me-2 text-success"></i>{{ __('admin.status.published') }}</a></li>
                                    <li><a class="dropdown-item" href="#" onclick="bulkChangeStatus('scheduled')"><i class="ti ti-clock me-2 text-info"></i>{{ __('admin.status.scheduled') }}</a></li>
                                    <li><a class="dropdown-item" href="#" onclick="bulkChangeStatus('unpublished')"><i class="ti ti-eye-off me-2 text-secondary"></i>{{ __('admin.status.unpublished') }}</a></li>
                                </ul>
                            </div>
                            <!-- Delete Button -->
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            @if($blog->author)
                                                {{ $blog->author->name }}
                                            @else
                                                <span class="badge bg-primary">{{ __('admin.blogs.team_author') }}</span>
                                            @endif
                                        </td>
                                        <td>
                                        ...
                                        <td>
                                            ...
                                            @elseif($blog->status === 'scheduled')
                                                <span class="badge bg-info"><i class="ti ti-clock me-1"></i>{{ __('admin.status.scheduled') }}</span>
