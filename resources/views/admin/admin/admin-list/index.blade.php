...
@section('content')
    ...
    <div class="d-flex flex-column flex-md-row justify-content-between align-items-start align-items-md-center mb-4 gap-3">
        ...
        <div class="d-flex gap-2">
            <a href="{{ route('admin.admins.trashed') }}" class="btn btn-outline-danger">
                <i class="ti ti-trash me-1"></i> {{ __('admin.admins.trash') }}
            </a>
                                        ...
                                        <div class="dropdown">
                                            ...
                                            <div class="dropdown-menu dropdown-menu-end">
                                                ...
                                                @if (auth('admin')->id() !== $admin->id)
                                                    ...
                                                    <a href="javascript:void(0);" class="dropdown-item text-danger delete-admin-btn"
...
document.addEventListener('DOMContentLoaded', function() {
    // Delete admin confirmation with SweetAlert
    document.querySelectorAll('.delete-admin-btn').forEach(function(button) {
        button.addEventListener('click', function() {
            ...
            Swal.fire({
                title: 'Hapus Admin?',
                html: `<p class="text-muted">Apakah Anda yakin ingin menghapus admin <strong>${adminName}</strong>?</p><p class="small text-muted mb-0">Tindakan ini tidak dapat dibatalkan.</p>`,
                icon: 'warning',
