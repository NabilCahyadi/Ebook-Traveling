...
@section('title', __('admin.ebooks.edit_ebook'))
                    ...
                    <div class="card-body">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control @error('title') is-invalid @enderror" id="title"
                                name="title" value="{{ old('title', $ebook->title) }}" placeholder="{{ __('admin.ebooks.title_placeholder') }}"
                                required>
                            @error('title')
                        ...
                        <div class="mb-3">
                            ...
                            <textarea class="form-control @error('description') is-invalid @enderror" id="description" name="description"
                                rows="5" placeholder="{{ __('admin.ebooks.description_placeholder') }}" minlength="47">{{ old('description', $ebook->description) }}</textarea>
                            <div class="form-text">
                                <i class="ti ti-info-circle me-1"></i>
                                {{ __('admin.common.min_chars', ['count' => 47]) }} <span id="char-count" class="text-muted">0/47</span>
                            </div>
                            @error('description')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        ...
                        <div class="row">
                            <div class="col-md-12 mb-3">
                                ...
                                <select class="form-select @error('status') is-invalid @enderror" id="status"
                                    ...
                                    <option value="draft"
                                        {{ old('status', $ebook->status) == 'draft' ? 'selected' : '' }}>{{ __('admin.ebooks.draft') }}</option>
                                    <option value="published"
                                        {{ old('status', $ebook->status) == 'published' ? 'selected' : '' }}>{{ __('admin.ebooks.published') }}
                                    </option>
                                    <option value="scheduled"
                                        {{ old('status', $ebook->status) == 'scheduled' ? 'selected' : '' }}>{{ __('admin.common.scheduled') }}
                                    </option>
                        ...
                        <div class="row" id="scheduledDateContainer" style="{{ old('status', $ebook->status) == 'scheduled' ? '' : 'display: none;' }}">
                            <div class="col-md-12 mb-3">
                                <label for="published_at" class="form-label"><i class="ti ti-calendar-time me-1"></i> {{ __('admin.ebooks.publish_date_time') }} <span class="text-danger">*</span></label>
                                ...
                                @error('published_at')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                                <div class="form-text">{{ __('admin.ebooks.publish_date_time_hint') }}</div>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="card mb-4">
                    <div class="card-body">
                        ...
                        @if ($ebook->cover_image)
                            <div class="mb-3">
                                <label class="form-label">{{ __('admin.ebooks.current_cover') }}</label>
                        ...
                        <div class="mb-3">
                            <label class="form-label">{{ __('admin.ebooks.change_cover') }}</label>
                            <input type="file" class="form-control @error('cover_image') is-invalid @enderror"
                                id="coverImageInput" name="cover_image" accept="image/*">
                            <small class="text-muted">{!! __('admin.ebooks.cover_hint') !!}</small>
                            @error('cover_image')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
                        ...
                        @if ($ebook->pdf_file)
                            <div class="mb-2">
                                <small class="text-success">
                                    <i class="ti ti-file-check me-1"></i> {{ __('admin.ebooks.pdf_exists') }}
                                </small>
                            </div>
                        @endif
                ...
                <div class="card">
                    <div class="card-body">
                        <button type="submit" class="btn btn-primary w-100 mb-2">
                            <i class="ti ti-check me-1"></i> {{ __('admin.ebooks.update_ebook') }}
                        </button>
...
@push('scripts')
    ...
    <script>
        ...
        function updateCharCount() {
            ...
            charCount.textContent = `${length}/47`;
