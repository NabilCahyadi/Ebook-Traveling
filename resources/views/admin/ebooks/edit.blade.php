...
<head>
    ...
    <title>Edit Ebook - Admin Dashboard</title>
                        ...
                        <div class="d-flex justify-content-between align-items-center mb-4">
                            <div>
                                <h4 class="fw-bold py-3 mb-2">
                                    <span class="text-muted fw-light">Ebook /</span> Edit Ebook
                                </h4>
                            </div>
                            <div>
                                        ...
                                        <div class="card-body">
                                            ...
                                            <div class="mb-3">
                                                ...
                                                <textarea class="form-control @error('description') is-invalid @enderror" id="description" name="description"
                                                    rows="4" required>{{ old('description', $ebook->description) }}</textarea>
                                                @error('description')
                                                    <div class="invalid-feedback">{{ $message }}</div>
                                                @enderror
                                            </div>
                                            ...
                                            <div class="mb-0">
                                                ...
                                                <textarea class="form-control @error('preview_content') is-invalid @enderror" id="preview_content"
                                                    name="preview_content" rows="3">{{ old('preview_content', $ebook->preview_content) }}</textarea>
                                    ...
                                    <div class="card mb-4">
                                        <div class="card-body">
                                            ...
                                            @if ($ebook->cover_image)
                                                <div class="mb-3">
                                                    <img src="{{ $ebook->cover_image }}" alt="Current cover"
                                                        class="img-fluid rounded w-100">
                                                    <small class="text-muted d-block mt-2">Current cover image</small>
                                                </div>
                                            @endif
                                            ...
                                            @if ($ebook->pdf_file)
                                                <div class="mb-3">
                                                    <div class="alert alert-info py-2 px-3 mb-2">
                                                        ...
                                                        <small>PDF file uploaded</small>
                                                    </div>
                                                    <small class="text-muted d-block">Current: {{ basename($ebook->pdf_file) }}</small>
                                                </div>
                                            @endif
                                    ...
                                    <div class="card">
                                        <div class="card-body">
                                            <button type="submit" class="btn btn-primary w-100 mb-2">
                                                <i class="ti ti-device-floppy me-1"></i> Update Ebook
                                            </button>
