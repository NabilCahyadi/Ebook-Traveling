                                ...
                                <td class="py-2 text-center">
                                    <div class="dropdown d-inline-block">
                                        ...
                                        <div class="dropdown-menu dropdown-menu-end">
                                            <form action="{{ route('admin.ebooks.restore', $ebook->id) }}" method="POST" style="display: inline;">
                                                @csrf
                                                @method('PATCH')
                                            ...
                                            <form action="{{ route('admin.ebooks.force-delete', $ebook->id) }}" method="POST" style="display: inline;">
                                                @csrf
                                                @method('DELETE')
