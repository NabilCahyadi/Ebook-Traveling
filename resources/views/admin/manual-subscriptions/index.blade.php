...
@section('title', __('admin.manual_subscription.title'))

@section('content')
    <div class="container-xxl flex-grow-1 container-p-y">
        <div class="d-flex justify-content-between align-items-center mb-4">
            <h4 class="fw-bold py-3 mb-0">
                <span class="text-muted fw-light">{{ __('admin.menu.subscription') }} /</span> {{ __('admin.manual_subscription.title') }}
            </h4>
            <a href="{{ route('admin.manual-subscriptions.create') }}" class="btn btn-primary">
                <i class="ti ti-plus me-1"></i> {{ __('admin.manual_subscription.create') }}
            </a>
        </div>
        ...
        <div class="card">
            ...
            <div class="table-responsive text-nowrap">
                <table class="table table-hover">
                    <thead>
                        <tr>
                            <th>{{ __('admin.manual_subscription.code') }}</th>
                            <th>{{ __('admin.manual_subscription.user') }}</th>
                            <th>{{ __('admin.manual_subscription.plan') }}</th>
                            <th>{{ __('admin.manual_subscription.start_date') }}</th>
                            <th>{{ __('admin.manual_subscription.end_date') }}</th>
                            <th>{{ __('admin.manual_subscription.status') }}</th>
                            <th>{{ __('admin.manual_subscription.amount') }}</th>
