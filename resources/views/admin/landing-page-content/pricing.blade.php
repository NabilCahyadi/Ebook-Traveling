...
@section('content')
    <div class="container-xxl flex-grow-1 container-p-y">
        ...
        <div class="d-flex justify-content-between align-items-center mb-4">
            ...
            <a href="{{ route('admin.landing-page-content.index') }}" class="btn btn-secondary">
        ...
        <div class="row">
            ...
            <div class="col-lg-8">
                <div class="card mb-4">
                    ...
                    <div class="card-body">
                        <form action="{{ route('admin.landing-page-content.pricing.update') }}" method="POST">
                            @csrf
                            @method('PUT')
                            ...
                            <div class="mb-4">
                                ...
                                <textarea class="form-control @error('description') is-invalid @enderror" 
                                          ...
                                          name="description" 
                                          rows="4"
                                          placeholder="e.g., Pilih paket berlangganan yang sesuai dengan kebutuhan perjalanan Anda">{{ old('description', $banner->description) }}</textarea>
                                @error('description')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                                <div class="form-text">
