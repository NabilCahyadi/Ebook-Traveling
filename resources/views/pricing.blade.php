            ...
            <div class="container text-center">
                ...
                @if (isset($groupedSubscriptionPlans) && $groupedSubscriptionPlans->isNotEmpty())
                    ...
                    <div class="tab-content" id="pricingTabContent">
                        @foreach ($groupedSubscriptionPlans as $categoryKey => $plans)
                            <div class="tab-pane fade {{ $loop->first ? 'show active' : '' }}" id="{{ $categoryKey }}"
                                role="tabpanel" aria-labelledby="{{ $categoryKey }}-tab">
                                    ...
                                    @foreach ($plans as $plan)
                                        ...
                                        @if ($user)
                                            ...
                                            @if ($user->currentSubscription && $user->currentSubscription->subscription_plan_id === $plan->id)
                                                <div class="modal fade" id="renewModal-{{ $plan->id }}" tabindex="-1"
                                                    data-bs-focus="false">
                                                        ...
                                                        <div class="modal-content border-0 shadow-lg">
                                                            <div class="modal-header bg-gradient-success text-white p-4">
                                                                <div>
                                                                    ...
                                                                    <small class="opacity-75">+{{ $plan->duration_days }}
                                                                        days access</small>
                                                                </div>
                                                                ...
                                                                <div
                                                                    ...
                                                                    <div class="d-flex align-items-center">
                                                                        ...
                                                                        <div class="ms-3">
                                                                            ...
                                                                            <div>
                                                                                {{ $user->currentSubscription->end_date->format('d M Y') }}
                                                                            </div>
                                                                        </div>
                                                                    </div>
                                                                </div>
                                                            ...
                                                            <div class="modal-footer bg-light p-3">
                                                                <form action="{{ route('api.subscription.create') }}"
                                                                    method="POST" class="w-100">
                                                                    @csrf
                                            ...
                                            @if ($user->currentPlan && $plan->price > $user->currentPlan->price)
                                                <div class="modal fade" id="upgradeModal-{{ $plan->id }}"
                                                                ...
                                                                <div
                                                                    ...
                                                                    <div class="text-center flex-grow-1">
                                                                        ...
                                                                        <h6 class="mb-1 fw-semibold">
                                                                            {{ $user->currentPlan->name }}</h6>
                                                                        <div class="text-dark fw-bold">
                                                                            Rp
                                                                            {{ number_format($user->currentPlan->price, 0, ',', '.') }}
                                                                        </div>
                                                                    </div>
