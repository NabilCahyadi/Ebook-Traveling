        ...
        <div class="search-info">
            <div class="row align-items-center">
                <div class="col-lg-8">
                    <h4 class="mb-0">
                        @if ($ebooks->total() > 0)
                            Found <span class="text-brand">{{ $ebooks->total() }}</span> results for
                            "<strong>{{ $query }}</strong>"
                        @else
                        ...
                        <div class="product-cart-wrap mb-30 wow animate__animated animate__fadeIn"
                            ...
                            <div class="product-content-wrap">
                                <h2 style="margin-top:15px;"><a
                                        href="/ebooks/{{ $ebook->slug }}">{{ Str::limit($ebook->title, 40) }}</a></h2>
                                ...
                                <p class="product-description">
                                    {{ Str::limit(strip_tags($ebook->short_description ?? $ebook->description), 75) }}</p>
