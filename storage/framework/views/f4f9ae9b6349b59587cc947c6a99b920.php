<?php $__env->startSection('title', 'Ebooks in ' . $city->name); ?>
    ...
    <div class="container">
        <div class="archive-header">
            <div class="row align-items-center">
                <div class="col-xl-12">
                    <h3 class="mb-15">E-books In <?php echo e($city->name); ?></h3>
                    <div class="breadcrumb">
                        <a href="/" rel="nofollow"><i class="fi fi-rs-home mr-5"></i>Home</a>
                        <span></span> E-books In <?php echo e($city->name); ?>
        ...
        <div class="row align-items-center">
            <div class="col-lg-8">
                <h4 class="mb-0">
                    ...
                    Found <span class="text-brand"><?php echo e($ebooks->total()); ?></span> ebook(s) in "<strong><?php echo e($city->name); ?></strong>"
                    <?php else: ?>
                    No ebooks found in "<strong><?php echo e($city->name); ?></strong>"
                    <?php endif; ?>
                </h4>
            </div>
        </div>
...
<?php echo $__env->make('layouts_lp.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\ebook_traveling\resources\views\city-filter.blade.php ENDPATH**/ ?>