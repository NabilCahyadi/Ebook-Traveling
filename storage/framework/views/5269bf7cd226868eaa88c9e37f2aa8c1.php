...
<?php $__env->startSection('title', 'Tambah Benefit Baru'); ?>
    ...
    <div class="container-xxl flex-grow-1 container-p-y">
        ...
        <div class="mb-4">
            <h4 class="fw-bold py-3 mb-2">
                <span class="text-muted fw-light">Website Management / Pricing Benefits /</span> Tambah Baru
            </h4>
        </div>
        ...
        <div class="row">
            <div class="col-md-8">
                <div class="card">
                    ...
                    <div class="card-body">
                        <form action="<?php echo e(route('admin.pricing-benefits.store')); ?>" method="POST">
                            <?php echo csrf_field(); ?>
...
unset($__errorArgs, $__bag); ?>
                            ...
                            <div class="d-flex justify-content-between">
                                <a href="<?php echo e(route('admin.pricing-benefits.index')); ?>" class="btn btn-label-secondary">
...
<script>
    ...
    $(document).ready(function() {
        ...
        function loadIcons(filter = '') {
            ...
            if (filter) {
                // Jika ada search, filter dari ALL icons (2000+)
                iconsToShow = allBootstrapIcons.filter(icon => icon.includes(filter.toLowerCase()));
            } else {
                // Tanpa search, tampilkan hanya recommended icons
                iconsToShow = recommendedIcons;
            }
                ...
                const iconHtml = `
                    <div class="col-6 col-sm-4 col-md-3">
                        <div class="icon-picker-item p-3 text-center border rounded cursor-pointer" data-icon="${iconClass}">
                            ...
                            <small class="d-block mt-2 text-truncate" title="${icon}">${icon}</small>
                        </div>
                    </div>
                `;
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\ebook_traveling\resources\views/admin/pricing-benefits/create.blade.php ENDPATH**/ ?>