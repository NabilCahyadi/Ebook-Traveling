<?php $__env->startSection('title', 'Edit Benefit'); ?>
        ...
        <div class="row">
            <div class="col-md-8">
                <div class="card">
                    ...
                    <div class="card-body">
                        <form action="<?php echo e(route('admin.about-us.update', $benefit->id)); ?>" method="POST">
                            <?php echo csrf_field(); ?>
...
unset($__errorArgs, $__bag); ?>
                            ...
                            <div class="mb-3">
                                ...
                                <div class="icon-preview-box" id="iconPreview">
                                    <i class="<?php echo e(old('icon', $benefit->icon)); ?>" style="font-size: 3rem; color: #FF4C61;"></i>
                                    <small class="d-block text-muted mt-2"><?php echo e(old('icon', $benefit->icon)); ?></small>
                                </div>
                            </div>
...
unset($__errorArgs, $__bag); ?>" 
                                          ...
                                          required><?php echo e(old('description', $benefit->description)); ?></textarea>
                            ...
                            <div class="mb-3">
                                ...
                                <div class="form-check form-switch">
                                    <input class="form-check-input" 
                                           ...
                                           name="status" 
                                           value="active" 
                                           <?php echo e(old('status', $benefit->status) === 'active' ? 'checked' : ''); ?>>
...
unset($__errorArgs, $__bag); ?>" 
                                       id="sort_order" 
                                       name="sort_order" 
                                       value="<?php echo e(old('sort_order', $benefit->sort_order)); ?>" 
                                       min="0">
...
unset($__errorArgs, $__bag); ?>
                ...
                <div class="card mt-3">
                    <div class="card-body">
                        ...
                        <form action="<?php echo e(route('admin.about-us.destroy', $benefit->id)); ?>" 
                              method="POST" 
                              id="deleteForm">
                            <?php echo csrf_field(); ?>
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\ebook_traveling\resources\views\admin\pricing-benefits\edit.blade.php ENDPATH**/ ?>