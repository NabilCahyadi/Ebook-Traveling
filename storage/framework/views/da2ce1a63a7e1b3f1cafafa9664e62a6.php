...
unset($__errorArgs, $__bag); ?>
                        ...
                        <!-- Role -->
                        <div class="col-md-6 mb-3">
                            <label for="role" class="form-label"><?php echo e(__('admin.form.role')); ?> <span class="text-danger">*</span></label>
...
unset($__errorArgs, $__bag); ?>" id="role" name="role"
                                required>
                                <option value=""><?php echo e(__('admin.common.select')); ?> <?php echo e(__('admin.form.role')); ?></option>
                                <?php
                                    $roles = \App\Models\Role::all();
                                    $selectedRole = old('role') ?? ($roleSlug ?? '');
                                ?>
                                <?php $__currentLoopData = $roles; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $role): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <option value="<?php echo e($role->slug); ?>" <?php echo e($selectedRole == $role->slug ? 'selected' : ''); ?>>
