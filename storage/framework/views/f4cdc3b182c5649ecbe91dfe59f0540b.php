        ...
        <div class="mb-4">
            <h4 class="fw-bold py-3 mb-2">
                <span class="text-muted fw-light">
                    <a href="<?php echo e(route('admin.pricing-benefits.index')); ?>" class="text-muted">Website Management / Pricing Benefits</a> /
                </span>
                Edit
            </h4>
        </div>
        ...
        <div class="row">
            <div class="col-md-8">
                <div class="card">
                    ...
                    <div class="card-body">
                        <form action="<?php echo e(route('admin.pricing-benefits.update', $benefit->id)); ?>" method="POST">
                            <?php echo csrf_field(); ?>
...
unset($__errorArgs, $__bag); ?>
                ...
                <div class="card mt-3">
                    <div class="card-body">
                        ...
                        <form action="<?php echo e(route('admin.pricing-benefits.destroy', $benefit->id)); ?>" 
                              method="POST" 
                              id="deleteForm">
                            <?php echo csrf_field(); ?>
