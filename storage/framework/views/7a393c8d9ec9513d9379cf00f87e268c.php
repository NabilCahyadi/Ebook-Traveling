<?php $__env->startSection('title', 'Create Contact Info'); ?>
...
<?php $__env->startSection('content'); ?>
    ...
    <div class="d-flex justify-content-between align-items-center mb-4">
        <div>
            ...
            <p class="mb-0">Tambah informasi kontak baru</p>
        </div>
    ...
    <div class="card">
        ...
        <div class="card-body">
            <form action="<?php echo e(route('admin.contact-info.store')); ?>" method="POST">
                <?php echo csrf_field(); ?>
...
unset($__errorArgs, $__bag); ?>" 
                            ...
                            <option value="whatsapp" <?php echo e(old('contact_type') == 'whatsapp' ? 'selected' : ''); ?>>WhatsApp</option>
                            <option value="email" <?php echo e(old('contact_type') == 'email' ? 'selected' : ''); ?>>Email</option>
                            <option value="phone" <?php echo e(old('contact_type') == 'phone' ? 'selected' : ''); ?>>Phone</option>
                            <option value="instagram" <?php echo e(old('contact_type') == 'instagram' ? 'selected' : ''); ?>>Instagram</option>
                            <option value="facebook" <?php echo e(old('contact_type') == 'facebook' ? 'selected' : ''); ?>>Facebook</option>
                            <option value="twitter" <?php echo e(old('contact_type') == 'twitter' ? 'selected' : ''); ?>>Twitter/X</option>
                            <option value="address" <?php echo e(old('contact_type') == 'address' ? 'selected' : ''); ?>>Address</option>
                            <option value="linkedin" <?php echo e(old('contact_type') == 'linkedin' ? 'selected' : ''); ?>>LinkedIn</option>
                            <option value="youtube" <?php echo e(old('contact_type') == 'youtube' ? 'selected' : ''); ?>>YouTube</option>
                            <option value="other" <?php echo e(old('contact_type') == 'other' ? 'selected' : ''); ?>>Other</option>
                        </select>
                    ...
                    <div class="col-md-6 mb-3">
                        <div class="form-check">
                            <input class="form-check-input" 
                                   ...
                                   <?php echo e(old('show_in_contact_page') ? 'checked' : ''); ?>>
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\ebook_traveling\resources\views\admin\contact-info\create.blade.php ENDPATH**/ ?>