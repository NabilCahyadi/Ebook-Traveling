        ...
        <div class="card">
            <div class="card-header">
                <div class="row align-items-center">
                    ...
                    <div class="col-md-6">
                        <form method="GET" action="<?php echo e(route('admin.subscription-management.list')); ?>">
                            <div class="input-group">
                                <span class="input-group-text"><i class="ti ti-search"></i></span>
                                <input type="text" class="form-control" name="search"
                                    placeholder="Search by user name, email, or code..." value="<?php echo e($search ?? ''); ?>">
                                <button type="submit" class="btn btn-primary">Search</button>
                                <?php if($search): ?>
                                    <a href="<?php echo e(route('admin.subscription-management.list')); ?>"
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\ebook_traveling\resources\views\admin\subscription-management\list.blade.php ENDPATH**/ ?>