<?php $__env->startSection('title', __('admin.blog_categories.create_category')); ?>
...
<?php $__env->startSection('content'); ?>
    ...
    <div class="d-flex justify-content-between align-items-center mb-4">
        <div>
            <h4 class="fw-bold py-3 mb-2">
                <span class="text-muted fw-light">Admin / Content Management / Blog Categories /</span> <?php echo e(__('admin.blog_categories.create')); ?>
    ...
    <div class="card">
        <div class="card-header">
            <h5 class="mb-0"><?php echo e(__('admin.blog_categories.create_new_category')); ?></h5>
        </div>
        <div class="card-body">
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="card bg-light">
                            <div class="card-body">
                                ...
                                <div class="alert alert-info mb-0">
                                    ...
                                    <small><?php echo e(__('admin.blog_categories.slug_auto_generate')); ?></small>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="mt-4">
                    <button type="submit" class="btn btn-primary">
                        <i class="ti ti-check me-1"></i> <?php echo e(__('admin.blog_categories.create_category')); ?>
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\ebook_traveling\resources\views\admin\blog-categories\create.blade.php ENDPATH**/ ?>