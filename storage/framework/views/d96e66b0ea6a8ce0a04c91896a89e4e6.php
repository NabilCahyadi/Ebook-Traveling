...
<?php $__env->startSection('content'); ?>
    ...
    <div class="d-flex justify-content-between align-items-center mb-4">
        <div>
            <h4 class="fw-bold py-3 mb-2">
                <span class="text-muted fw-light"><?php echo e(__('admin.menu.admin')); ?> / <a href="<?php echo e(route('admin.roles.index')); ?>"><?php echo e(__('admin.roles.title')); ?></a> /</span> <?php echo e(__('admin.roles.add_role')); ?>
    ...
    <div class="card">
        <div class="card-header">
            <h5 class="mb-0"><?php echo e(__('admin.roles.add_role')); ?></h5>
        </div>
        <div class="card-body">
...
unset($__errorArgs, $__bag); ?>
                ...
                <div class="mb-3">
                    <label for="slug" class="form-label"><?php echo e(__('admin.form.slug')); ?> <small class="text-muted">(optional, auto-generated)</small></label>
...
unset($__errorArgs, $__bag); ?>
                ...
                <div class="mt-4">
                    <button type="submit" class="btn btn-primary">
                        <i class="ti ti-check me-1"></i> <?php echo e(__('admin.buttons.create')); ?>
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\ebook_traveling\resources\views\admin\roles\create.blade.php ENDPATH**/ ?>