                                ...
                                <div class="detail-info pr-30 pl-30">
                                    ...
                                    <div class="short-desc mb-30">
                                        ...
                                        <div class="font-lg description-content" id="ebookDescription"
                                            data-full-text="<?php echo e(htmlspecialchars($fullDescription)); ?>">
                                            <?php if($needsShowMore): ?>
                                                <span
                                                    class="truncated-desc"><?php echo e(substr($fullDescription, 0, $charLimit)); ?>...</span>
                                                <span class="full-desc"
                                                    style="display: none;"><?php echo e($fullDescription); ?></span>
                                            <?php else: ?>
                                                <?php echo e($fullDescription); ?>
                                    ...
                                    <div class="font-xs">
                                        <ul class="mr-50 float-start">
                                            <li class="mb-5">Creator : <span
                                                    class="text-brand"><?php echo e($ebook->creator->name ?? ($ebook->author ?? 'Unknown')); ?></span>
                                            </li>
                                            <li class="mb-5">
                                                Language :
                                            ...
                                            <li>Published : <span
                                                    class="text-brand"><?php echo e(\Carbon\Carbon::parse($ebook->published_at)->format('d M Y')); ?></span>
                                            </li>
                                            <li class="d-flex align-items-center gap-2">
                                                ...
                                                <?php if(auth()->check()): ?>
                                                    <div style="display: flex; align-items: center;">
                                                        <button id="favorite-btn-<?php echo e($ebook->id); ?>"
                                                            class="favorite-btn <?php echo e($isSaved ? 'saved' : ''); ?>"
                                                            data-ebook-id="<?php echo e($ebook->id); ?>"
                                                            title="<?php echo e($isSaved ? 'Remove from saved' : 'Save this book'); ?>">
                                                            <i
                                                                class="bi <?php echo e($isSaved ? 'bi-heart-fill' : 'bi-heart'); ?>"></i>
                                                        </button>
                                                    </div>
                                                <?php endif; ?>
                                            </li>
                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-8">
                                    <div class="review-container">
                                        ...
                                        <div class="showing-info">Showing <?php echo e($ratings->firstItem()); ?> to
                                            <?php echo e($ratings->lastItem()); ?> of <?php echo e($ratings->total()); ?> reviews</div>
                                            ...
                                            <?php $__empty_1 = true; $__currentLoopData = $ratings; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $rating): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                                <div class="single-comment mb-30">
                                                    <div class="review-header">
                                                        <div class="product-rate d-inline-block">
                                                            <div class="product-rating"
                                                                style="width: <?php echo e(($rating->rating / 5) * 100); ?>%"></div>
                                                        </div>
                                                        <div class="review-date">
                                                            <?php echo e($rating->created_at->format('F d, Y')); ?></div>
                                                    </div>
                                                    <div class="review-user">
                                                        <div class="avatar-container">
                                                            <img src="<?php echo e($rating->user->avatar ? asset('storage/' . $rating->user->avatar) : asset('/images/user-avatar.png')); ?>"
                                                                alt="<?php echo e($rating->user->name); ?>" class="user-avatar" />
                                                        </div>
                                                        <a href=""
                                                            class="username ms-3"><?php echo e($rating->user->name); ?></a>
                                                    </div>
                                                    <div class="review-text-container">
                                                        
                                                        <p class="truncated-text">
                                                            <?php echo e(Str::limit($rating->review_text, 180)); ?></p>

                                                        
                                                        <p class="full-text" style="display: none;">
                                                            <?php echo e($rating->review_text); ?></p>
                                ...
                                <div class="col-lg-4">
                                    <div class="rating-container">
                                        ...
                                        <div class="d-flex align-items-center mb-15">
                                            ...
                                            <div class="progress flex-grow-1">
                                                <div class="progress-bar" role="progressbar"
                                                    style="width: <?php echo e($ebook->total_reviews > 0 ? ($ratingDistribution[5] / $ebook->total_reviews) * 100 : 0); ?>%"
                                                    aria-valuenow="<?php echo e($ebook->total_reviews > 0 ? ($ratingDistribution[5] / $ebook->total_reviews) * 100 : 0); ?>"
                                        ...
                                        <div class="d-flex align-items-center mb-15">
                                            ...
                                            <div class="progress flex-grow-1">
                                                <div class="progress-bar" role="progressbar"
                                                    style="width: <?php echo e($ebook->total_reviews > 0 ? ($ratingDistribution[4] / $ebook->total_reviews) * 100 : 0); ?>%"
                                                    aria-valuenow="<?php echo e($ebook->total_reviews > 0 ? ($ratingDistribution[4] / $ebook->total_reviews) * 100 : 0); ?>"
                                                    aria-valuemin="0" aria-valuemax="100">
                                        ...
                                        <div class="d-flex align-items-center mb-15">
                                            ...
                                            <div class="progress flex-grow-1">
                                                <div class="progress-bar" role="progressbar"
                                                    style="width: <?php echo e($ebook->total_reviews > 0 ? ($ratingDistribution[3] / $ebook->total_reviews) * 100 : 0); ?>%"
                                                    aria-valuenow="<?php echo e($ebook->total_reviews > 0 ? ($ratingDistribution[3] / $ebook->total_reviews) * 100 : 0); ?>"
                                                    aria-valuemin="0" aria-valuemax="100">
                                        ...
                                        <div class="d-flex align-items-center mb-15">
                                            ...
                                            <div class="progress flex-grow-1">
                                                <div class="progress-bar" role="progressbar"
                                                    style="width: <?php echo e($ebook->total_reviews > 0 ? ($ratingDistribution[2] / $ebook->total_reviews) * 100 : 0); ?>%"
                                                    aria-valuenow="<?php echo e($ebook->total_reviews > 0 ? ($ratingDistribution[2] / $ebook->total_reviews) * 100 : 0); ?>"
                                                    aria-valuemin="0" aria-valuemax="100">
                                        ...
                                        <div class="d-flex align-items-center mb-30">
                                            ...
                                            <div class="progress flex-grow-1">
                                                <div class="progress-bar" role="progressbar"
                                                    style="width: <?php echo e($ebook->total_reviews > 0 ? ($ratingDistribution[1] / $ebook->total_reviews) * 100 : 0); ?>%"
                                                    aria-valuenow="<?php echo e($ebook->total_reviews > 0 ? ($ratingDistribution[1] / $ebook->total_reviews) * 100 : 0); ?>"
                                                    aria-valuemin="0" aria-valuemax="100">
                            ...
                            <?php if(auth()->check()): ?>
                                ...
                                <?php if(auth()->user()->hasActiveSubscription()): ?>
                                    ...
                                    <?php if(!$hasReviewed): ?>
                                        ...
                                        <form class="form-contact comment_form" action="<?php echo e(route('ratings.store')); ?>"
                                            method="POST">
                                            <?php echo csrf_field(); ?>
                                ...
                                <div class="alert alert-custom-info d-flex align-items-center" role="alert">
                                    ...
                                    <div class="flex-grow-1 ms-3">
                                        ...
                                        <div>
                                            ...
                                            <a href="<?php echo e(route('login')); ?>?form=register"
                                ...
                                <?php $__empty_1 = true; $__currentLoopData = $moreOptionsEbooks; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $ebook): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                    ...
                                    <div class="col-lg-3 col-md-4 col-12 col-sm-6">
                                        <div class="product-cart-wrap mb-30 hover-up wow animate__animated animate__fadeIn"
                                            data-wow-delay="<?php echo e(($loop->index + 1) * 0.1); ?>s">
                                            ...
                                            <div class="product-content-wrap">
                                                <h2 style="margin-top:15px;"><a
                                                        href="<?php echo e(route('ebooks.show', $ebook->slug)); ?>"><?php echo e(Str::limit($ebook->title, 40)); ?></a>
                                                </h2>

                                                <div class="product-author" style="margin-bottom:-4px;">
                                                    <?php if($ebook->creator): ?>
                                                        <span>by <?php echo e($ebook->creator->name); ?></span>
                                                    <?php else: ?>
                                                ...
                                                <div class="product-description">
                                                    <?php echo e(Str::limit(strip_tags($ebook->short_description ?? $ebook->description), 75)); ?>
