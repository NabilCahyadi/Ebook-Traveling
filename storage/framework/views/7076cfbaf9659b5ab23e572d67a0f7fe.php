        ...
        <?php $__currentLoopData = $landingSections; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $section): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <?php switch($section->section_type):
                ...
                <?php case ('subscription_plans'): ?>
                    <?php echo $__env->make('components.landing.subscription-plans', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
                <?php break; ?>
                ...
                <?php case ('latest_blogs'): ?>
                    <?php echo $__env->make('components.landing.latest-blogs', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
                <?php break; ?>
            <?php endswitch; ?>
