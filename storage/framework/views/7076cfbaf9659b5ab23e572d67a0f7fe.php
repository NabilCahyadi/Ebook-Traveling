                        ...
                        <?php $__currentLoopData = $topCities; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $city): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <div class="card-2 bg-12 wow animate__animated animate__fadeInUp"
                                ...
                                <figure class="img-hover-scale overflow-hidden"
                                    style="width: 100px; height: 80px; margin: 0 auto 10px; border-radius: 8px;">
                                ...
                                <span><?php echo e($city->items_count); ?> items</span>
                            </div>
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                    ...
                    <?php $__currentLoopData = $subscriptionPlans; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $plan): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        ...
                        <div class="<?php echo e($colClass); ?>">
                            <div class="banner-img wow animate__animated animate__fadeInUp"
                                data-wow-delay="<?php echo e($delay); ?>s">
    ...
    <?php endif; ?> -->
                                                        ...
                                                        <div class="product-content-wrap">
                                                            <h2 style="margin-top:15px;"><a
                                                                    href="/ebook/<?php echo e($ebook->slug); ?>"><?php echo e(Str::limit($ebook->title, 40)); ?></a>
                                                            </h2>
                                                            ...
                                                            <div class="product-meta">
                                                                <div class="product-rate-cover">
                                                                    ...
                                                                    <span
                                                                        class="font-small ml-5 text-muted">(<?php echo e($ebook->average_rating); ?>)</span>
                                                                </div>
                                                                <div class="read-count">
                                                                    <i class="fi-rs-eye mt-5"></i>
                                                                    <?php echo e(number_format($ebook->read_count)); ?>
                                                            ...
                                                            <?php if(auth()->check() && auth()->user()->hasActiveSubscription()): ?>
                                                                <a href="/reader/<?php echo e($ebook->slug); ?>"
        ...
        <section class="section-padding pb-5">
            <div class="container">
                <div class="section-title wow animate__animated animate__fadeIn">
                    ...
                    <a href="<?php echo e(route('promo')); ?>" class="show-all">View All</a>
                </div>
                <div class="row">
                                            ...
                                            <div class="product-img-action-wrap">
                                                <div class="product-img product-img-zoom">
                                                    <a href="shop-product-right.html">
                                                        <img class="default-img"
                                                            src="assets-nest/nest-fe/imgs/shop/product-1-1.jpg"
                                                            alt="" />
                                                        <img class="hover-img"
                                                            src="assets-nest/nest-fe/imgs/shop/product-1-2.jpg"
                                                            alt="" />
                                                    </a>
                                                </div>
                                        ...
                                        <div class="product-cart-wrap">
                                            <div class="product-img-action-wrap">
                                                <div class="product-img product-img-zoom">
                                                    <a href="shop-product-right.html">
                                                        <img class="default-img"
                                                            src="assets-nest/nest-fe/imgs/shop/product-5-1.jpg"
                                                            alt="" />
                                                        <img class="hover-img"
                                                            src="assets-nest/nest-fe/imgs/shop/product-5-2.jpg"
                                                            alt="" />
                                                    </a>
                                                </div>
                                                <div class="product-action-1">
                                        ...
                                        <div class="product-cart-wrap">
                                            <div class="product-img-action-wrap">
                                                <div class="product-img product-img-zoom">
                                                    <a href="shop-product-right.html">
                                                        <img class="default-img"
                                                            src="assets-nest/nest-fe/imgs/shop/product-2-1.jpg"
                                                            alt="" />
                                                        <img class="hover-img"
                                                            src="assets-nest/nest-fe/imgs/shop/product-2-2.jpg"
                                                            alt="" />
                                                    </a>
                                                </div>
                                                <div class="product-action-1">
                                        ...
                                        <div class="product-cart-wrap">
                                            <div class="product-img-action-wrap">
                                                <div class="product-img product-img-zoom">
                                                    <a href="shop-product-right.html">
                                                        <img class="default-img"
                                                            src="assets-nest/nest-fe/imgs/shop/product-3-1.jpg"
                                                            alt="" />
                                                        <img class="hover-img"
                                                            src="assets-nest/nest-fe/imgs/shop/product-3-2.jpg"
                                                            alt="" />
                                                    </a>
                                                </div>
                                                <div class="product-action-1">
                                        ...
                                        <div class="product-cart-wrap">
                                            <div class="product-img-action-wrap">
                                                <div class="product-img product-img-zoom">
                                                    <a href="shop-product-right.html">
                                                        <img class="default-img"
                                                            src="assets-nest/nest-fe/imgs/shop/product-4-1.jpg"
                                                            alt="" />
                                                        <img class="hover-img"
                                                            src="assets-nest/nest-fe/imgs/shop/product-4-2.jpg"
                                                            alt="" />
                                                    </a>
                                                </div>
                                                <div class="product-action-1">
        ...
        <section class="section-padding pb-5">
            <div class="container mb-30">
                <div class="section-title style-2 flex-container-custom">
                    ...
                    <a href="<?php echo e(route('blogs')); ?>" class="show-all">View All</a>
                </div>
                <div class="loop-grid">
                    <div class="row">
                                    ...
                                    <a href="<?php echo e(route('blogs.show', $blog->slug)); ?>">
                                        <?php if($blog->featured_image): ?>
                                            <img class="border-radius-15"
                                                src="<?php echo e(asset('storage/' . $blog->featured_image)); ?>"
                                                alt="<?php echo e($blog->title); ?>" />
                                        <?php else: ?>
                                            <img class="border-radius-15" src="<?php echo e(asset('images/blogs/default.webp')); ?>"
                                                alt="<?php echo e($blog->title); ?>" />
                                        <?php endif; ?>
                                    </a>
                                </div>
                                <div class="entry-content-2">
                                    <?php if($blog->category): ?>
                                        <h6 class="mb-10 font-sm">
                                            <a class="entry-meta text-muted" href="#"><?php echo e($blog->category); ?></a>
                                        </h6>
                                    <?php endif; ?>
                                    <h4 class="post-title mb-15">
                                        <a
                                            href="<?php echo e(route('blogs.show', $blog->slug)); ?>"><?php echo e(Str::limit($blog->title, 80)); ?></a>
                                    </h4>
                                    <div class="entry-meta font-xs color-grey mt-10 pb-10">
                                        <div>
                                            <span
                                                class="post-on mr-10"><?php echo e($blog->published_at ? $blog->published_at->format('d M Y') : $blog->created_at->format('d M Y')); ?></span>
                                            <span class="hit-count has-dot mr-10"><?php echo e(number_format($blog->view_count)); ?>

                                                Views</span>
                                            <span class="hit-count has-dot"><?php echo e($blog->read_time ?? 5); ?> mins read</span>
                                        </div>
                                    </div>
                                </div>
                            </article>
