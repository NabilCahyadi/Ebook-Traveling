                            ...
                            <div class="detail-info pr-30 pl-30">
                                ...
                                <div class="font-xs">
                                    <ul class="mr-50 float-start">
                                        <li class="mb-5">Creator : <span class="text-brand"><?php echo e($ebook->creator->name ?? $ebook->author ?? 'Unknown'); ?></span></li>
                                        <li class="mb-5">
                                            Language :
                                        ...
                                        <li class="d-flex align-items-center gap-2">
                                            ...
                                            <?php if(auth()->check()): ?>
                                            <form method="POST" action="<?php echo e(route('ebooks.save.toggle', $ebook->id)); ?>" class="d-inline btn-favorite-form">
                                                <?php echo csrf_field(); ?>
                                                <button class="control-btn favorite-btn"
                                                    data-ebook-id="<?php echo e($ebook->id); ?>"
                                                    data-is-saved="<?php echo e($isSaved ? '1' : '0'); ?>"
                                                    style="background-color: <?php echo e($isSaved ? '#ffffff' : '#FF4C61'); ?>; border: 1px solid #FF4C61; width: 45px; height: 45px; padding: 0; margin-top:15px;"
                                                    title="<?php echo e($isSaved ? 'Remove from saved' : 'Save this book'); ?>">
                                                    <i class="bi <?php echo e($isSaved ? 'bi-heart-fill' : 'bi-heart'); ?>"
                                                        style="color: <?php echo e($isSaved ? '#FF4C61' : '#ffffff'); ?>; font-size: 16px;"></i>
                                                </button>
                                            </form>
                                            <?php endif; ?>
                                        </li>
