                                    ...
                                    <div class="comment-list">
                                        ...
                                        <div class="single-comment mb-30">
                                            <div class="review-header">
                                                ...
                                                <div class="review-date"><?php echo e($rating->created_at->format('F d, Y \a\t g:i A')); ?></div>
                                            </div>
                            ...
                            <div class="col-lg-4">
                                <div class="rating-container">
                                    ...
                                    <div class="d-flex mb-30">
                                        ...
                                        <!-- <h6><?php echo e(number_format($ebook->average_rating, 1)); ?> out of 5</h6> -->
                                    </div>

                                    <div class="progress">
                                        <span>5 star</span>
                                        <div class="progress-bar" role="progressbar" style="width: <?php echo e(($ebook->total_reviews > 0) ? ($ratingDistribution[5] / $ebook->total_reviews) * 100 : 0); ?>%" aria-valuenow="<?php echo e(($ebook->total_reviews > 0) ? ($ratingDistribution[5] / $ebook->total_reviews) * 100 : 0); ?>" aria-valuemin="0" aria-valuemax="100"><?php echo e(($ebook->total_reviews > 0) ? number_format(($ratingDistribution[5] / $ebook->total_reviews) * 100) : 0); ?>%</div>
                                    </div>
                                    <div class="progress">
                                        <span>4 star</span>
                                        <div class="progress-bar" role="progressbar" style="width: <?php echo e(($ebook->total_reviews > 0) ? ($ratingDistribution[4] / $ebook->total_reviews) * 100 : 0); ?>%" aria-valuenow="<?php echo e(($ebook->total_reviews > 0) ? ($ratingDistribution[4] / $ebook->total_reviews) * 100 : 0); ?>" aria-valuemin="0" aria-valuemax="100"><?php echo e(($ebook->total_reviews > 0) ? number_format(($ratingDistribution[4] / $ebook->total_reviews) * 100) : 0); ?>%</div>
                                    </div>
                                    <div class="progress">
                                        <span>3 star</span>
                                        <div class="progress-bar" role="progressbar" style="width: <?php echo e(($ebook->total_reviews > 0) ? ($ratingDistribution[3] / $ebook->total_reviews) * 100 : 0); ?>%" aria-valuenow="<?php echo e(($ebook->total_reviews > 0) ? ($ratingDistribution[3] / $ebook->total_reviews) * 100 : 0); ?>" aria-valuemin="0" aria-valuemax="100"><?php echo e(($ebook->total_reviews > 0) ? number_format(($ratingDistribution[3] / $ebook->total_reviews) * 100) : 0); ?>%</div>
                                    </div>
                                    <div class="progress">
                                        <span>2 star</span>
                                        <div class="progress-bar" role="progressbar" style="width: <?php echo e(($ebook->total_reviews > 0) ? ($ratingDistribution[2] / $ebook->total_reviews) * 100 : 0); ?>%" aria-valuenow="<?php echo e(($ebook->total_reviews > 0) ? ($ratingDistribution[2] / $ebook->total_reviews) * 100 : 0); ?>" aria-valuemin="0" aria-valuemax="100"><?php echo e(($ebook->total_reviews > 0) ? number_format(($ratingDistribution[2] / $ebook->total_reviews) * 100) : 0); ?>%</div>
                                    </div>
                                    <div class="progress mb-30">
                                        <span>1 star</span>
                                        <div class="progress-bar" role="progressbar" style="width: <?php echo e(($ebook->total_reviews > 0) ? ($ratingDistribution[1] / $ebook->total_reviews) * 100 : 0); ?>%" aria-valuenow="<?php echo e(($ebook->total_reviews > 0) ? ($ratingDistribution[1] / $ebook->total_reviews) * 100 : 0); ?>" aria-valuemin="0" aria-valuemax="100"><?php echo e(($ebook->total_reviews > 0) ? number_format(($ratingDistribution[1] / $ebook->total_reviews) * 100) : 0); ?>%</div>
                                    </div>
                                </div>
                            </div>
                        </div>
