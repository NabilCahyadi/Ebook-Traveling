...
<?php $__env->startSection('meta'); ?>
    ...
    <meta name="keywords"
        content="<?php echo e($blog->meta_keywords ?: ($blog->tags ? implode(', ', $blog->tags) : 'blog, travel, meatmap')); ?>">
    ...
    <meta name="twitter:description"
        content="<?php echo e($blog->meta_description ?: Str::limit(strip_tags($blog->content), 160)); ?>">
                                    ...
                                    <div class="single-header style-2">
                                        <div class="row">
                                            <div class="col-xl-10 col-lg-12 m-auto">
                                                <h6 class="mb-10" style="color: #FF4C61;"><?php echo e($blog->category); ?></h6>
                                                ...
                                                <div class="single-header-meta">
                                                    <div class="entry-meta meta-1 font-xs mt-15 mb-15">
                                                        ...
                                                        <span
                                                            class="post-on has-dot"><?php echo e(\Carbon\Carbon::parse($blog->published_at)->diffInHours() < 24 ? $blog->published_at->diffForHumans() : $blog->published_at->format('d M Y')); ?></span>
                                                ...
                                                <?php if(isset($blog) && $blog->tags && count($blog->tags) > 0): ?>
                                                    <div class="entry-bottom mt-50 mb-30">
                                                        <div class="d-flex flex-wrap align-items-center">
                                                            <?php $__currentLoopData = $blog->tags; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $tag): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                                <a href="<?php echo e(route('blogs.by.tag', ['tag' => $tag])); ?>"
                                                                    rel="tag"
                                            ...
                                            <?php $__currentLoopData = $blog->ebooks; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $ebook): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <div class="single-post clearfix">
                                                    ...
                                                    <div class="content pt-10">
                                                        <h6><a href="<?php echo e(route('ebooks.show', $ebook->slug)); ?>"
                                                                class="ebook-title-link"><?php echo e($ebook->title); ?></a></h6>
