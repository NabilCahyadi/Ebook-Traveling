                ...
                <div class="col-lg-8">
                    <h4 class="mb-0">
                        <?php if($ebooks->total() > 0): ?>
                            Found <span class="text-brand"><?php echo e($ebooks->total()); ?></span> results for
                            "<strong><?php echo e($query); ?></strong>"
                        <?php else: ?>
                            No results found for "<strong><?php echo e($query); ?></strong>"
                        <?php endif; ?>
                    </h4>
                </div>
                <div class="col-lg-4 text-end">
                    <form action="<?php echo e(route('search')); ?>" method="GET" class="d-inline-flex gap-2 w-100">
                        <input type="text" name="q" value="<?php echo e($query); ?>" class="form-control"
                            placeholder="Try another search...">
                        <button type="submit" class="btn-read-now text-white px-4 py-2 mb-1" style="white-space: nowrap;">
                            <i class="fi fi-rs-search"></i> Search
                        </button>
                    </form>
                </div>
            </div>
        ...
        <?php if($ebooks->total() > 0): ?>
                        ...
                        <div class="product-cart-wrap mb-30 wow animate__animated animate__fadeIn"
                            ...
                            <div class="product-content-wrap">
                                <h2 style="margin-top:15px;"><a
                                        href="/ebooks/<?php echo e($ebook->slug); ?>"><?php echo e(Str::limit($ebook->title, 40)); ?></a></h2>
                                ...
                                <p class="product-description">
                                    <?php echo e(Str::limit(strip_tags($ebook->short_description ?? $ebook->description), 75)); ?></p>

                                
                                <?php if(auth()->guard()->check()): ?>
                                    <?php if(auth()->user()->hasActiveSubscription() || $ebook->is_free): ?>
            ...
            <div class="pagination-area mt-20 mb-20">
                <nav aria-label="Page navigation">
                    <?php echo e($ebooks->appends(['q' => $query])->links('pagination::bootstrap-4')); ?>

                </nav>
            </div>
        <?php else: ?>
            <div class="text-center py-5">
                <img src="/images/no-results.svg" alt="No Results" style="max-width: 300px; opacity: 0.5;"
...
<?php echo $__env->make('layouts_lp.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\ebook_traveling\resources\views\search-results.blade.php ENDPATH**/ ?>