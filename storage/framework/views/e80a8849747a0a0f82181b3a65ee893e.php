<aside id="layout-menu" class="layout-menu menu-vertical menu bg-menu-theme">
    <div class="app-brand demo">
        <a href="<?php echo e(route('admin.dashboard')); ?>" class="app-brand-link">
            <span class="app-brand-logo demo" style="display: flex; align-items: center;">
                <img src="<?php echo e(asset('images/only-logoo.png')); ?>" alt="MeatMap Logo"
    ...
    <ul class="menu-inner py-1">
        ...
        <?php if(auth('admin')->check() && auth('admin')->user()->type === 'superadmin'): ?>
            <li
                class="menu-item <?php echo e(Request::is('admin/admins*') || Request::is('admin/admin-activity-logs*') ? 'active open' : ''); ?>">
                ...
                <ul class="menu-sub">
                    <!-- Admin List -->
                    <li
                        class="menu-item <?php echo e(Request::is('admin/admins*') && !Request::is('admin/admin-activity-logs*') ? 'active' : ''); ?>">
        ...
        <?php if(auth('admin')->user()->isSuperAdmin() || auth('admin')->user()->hasAnyPermission(['users.view', 'users.create', 'users.edit', 'users.delete', 'roles.view', 'roles.create', 'roles.edit', 'roles.delete'])): ?>
            <li
                class="menu-item <?php echo e(Request::is('admin/users*') || Request::is('admin/roles*') || Request::is('admin/role-permissions*') || Request::is('admin/user-activity-logs*') ? 'active open' : ''); ?>">
                <a href="javascript:void(0);" class="menu-link menu-toggle">
                ...
                <ul class="menu-sub">
                    ...
                    <?php if(auth('admin')->user()->isSuperAdmin() || auth('admin')->user()->hasPermission('users.view')): ?>
                        <li class="menu-item <?php echo e(Request::is('admin/users*') ? 'active open' : ''); ?>">
                            ...
                            <ul class="menu-sub">
                                <li class="menu-item <?php echo e(Request::is('admin/users') && !Request::get('role') ? 'active' : ''); ?>">
                                ...
                                <?php if(isset($sidebarRoles) && $sidebarRoles->count() > 0): ?>
                                    <?php $__currentLoopData = $sidebarRoles; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $role): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <li class="menu-item <?php echo e(Request::get('role') === $role->slug ? 'active' : ''); ?>">
                                            <a href="<?php echo e(route('admin.users.index', ['role' => $role->slug])); ?>" class="menu-link">
        ...
        <?php if(auth('admin')->user()->isSuperAdmin() || auth('admin')->user()->hasAnyPermission(['ebooks.view', 'ebooks.create', 'ebooks.edit', 'ebooks.delete', 'ebooks.approve', 'categories.view', 'categories.create', 'categories.edit', 'categories.delete', 'cities.view', 'cities.create', 'cities.edit', 'cities.delete'])): ?>
            <li
                class="menu-item <?php echo e(Request::is('admin/ebooks*') || Request::is('admin/categories*') || Request::is('admin/cities*') ? 'active open' : ''); ?>">
                <a href="javascript:void(0);" class="menu-link menu-toggle">
                    ...
                    <?php if(auth('admin')->user()->isSuperAdmin() || auth('admin')->user()->hasPermission('ebooks.view')): ?>
                        <li class="menu-item <?php echo e(Request::is('admin/ebooks*') ? 'active open' : ''); ?>">
                            ...
                            <ul class="menu-sub">
                                ...
                                <li
                                    class="menu-item <?php echo e(Request::is('admin/ebooks') && !Request::is('admin/ebooks/create') && !Request::is('admin/ebooks/trash') ? 'active' : ''); ?>">
                                ...
                                <li class="menu-item <?php echo e(Request::is('admin/ebooks/trash') ? 'active' : ''); ?>">
                                    <a href="<?php echo e(route('admin.ebooks.trash')); ?>" class="menu-link">
                                        <div data-i18n="Trash">Trash</div>
                                        <?php
                                            $trashedCount = \App\Models\Ebook::onlyTrashed()->count();
                                        ?>
                                        <?php if($trashedCount > 0): ?>
                                            <span class="badge bg-danger rounded-pill ms-auto"><?php echo e($trashedCount); ?></span>
                                        <?php endif; ?>
                                    </a>
                                </li>
                            </ul>
        ...
        <?php if(auth('admin')->user()->isSuperAdmin() || auth('admin')->user()->hasAnyPermission(['blogs.view', 'blogs.create', 'blogs.edit', 'blogs.delete', 'blog-categories.view', 'blog-categories.create', 'blog-categories.edit', 'blog-categories.delete'])): ?>
            <li
                class="menu-item <?php echo e(Request::is('admin/blogs*') || Request::is('admin/blog-categories*') ? 'active open' : ''); ?>">
                <a href="javascript:void(0);" class="menu-link menu-toggle">
                ...
                <ul class="menu-sub">
                    ...
                    <?php if(auth('admin')->user()->isSuperAdmin() || auth('admin')->user()->hasPermission('blogs.view')): ?>
                        <li class="menu-item <?php echo e(Request::is('admin/blogs*') && !Request::is('admin/blog-categories*') ? 'active open' : ''); ?>">
                            ...
                            <ul class="menu-sub">
                                <li class="menu-item <?php echo e(Request::is('admin/blogs/create') ? 'active' : ''); ?>">
                                    <a href="<?php echo e(route('admin.blogs.create')); ?>" class="menu-link">
                                        <div data-i18n="Add New Blog">Add New Blog</div>
                                    </a>
                                </li>
                                <li
                                    class="menu-item <?php echo e(Request::is('admin/blogs') && !Request::is('admin/blogs/create') && !Request::is('admin/blogs/trash') ? 'active' : ''); ?>">
                                    <a href="<?php echo e(route('admin.blogs.index')); ?>" class="menu-link">
                                        <div data-i18n="All Blogs">All Blogs</div>
                                    </a>
                                </li>
                                <li class="menu-item <?php echo e(Request::is('admin/blogs/trash') ? 'active' : ''); ?>">
                                    <a href="<?php echo e(route('admin.blogs.trash')); ?>" class="menu-link">
                                        <div data-i18n="Trash">Trash</div>
                                        <?php
                                            $trashedBlogsCount = \App\Models\Blog::onlyTrashed()->count();
                                        ?>
                                        <?php if($trashedBlogsCount > 0): ?>
                                            <span class="badge bg-danger rounded-pill ms-auto"><?php echo e($trashedBlogsCount); ?></span>
                                        <?php endif; ?>
                                    </a>
                                </li>
                            </ul>
        ...
        <?php if(auth('admin')->user()->isSuperAdmin() || auth('admin')->user()->hasAnyPermission(['subscription-plans.view', 'subscription-plans.create', 'subscription-plans.edit', 'subscription-plans.delete', 'subscriptions.view', 'subscriptions.create', 'subscriptions.edit', 'subscriptions.delete', 'promos.view', 'promos.create', 'promos.edit', 'promos.delete'])): ?>
            <li
                class="menu-item <?php echo e(Request::is('admin/subscription-plans*') || Request::is('admin/manual-subscriptions*') || Request::is('admin/active-subscribers*') || Request::is('admin/subscription-history*') || Request::is('admin/promos*') ? 'active open' : ''); ?>">
                <a href="javascript:void(0);" class="menu-link menu-toggle">
        ...
        ?>
        <?php if(auth('admin')->user()->isSuperAdmin() || auth('admin')->user()->hasAnyPermission($websitePermissions)): ?>
            <li
                class="menu-item <?php echo e(Request::is('admin/collection-order*') || Request::is('admin/banners*') || Request::is('admin/collections*') || Request::is('admin/landing-page-content*') || Request::is('admin/about-us*') || Request::is('admin/contact-info*') || Request::is('admin/site-settings*') || Request::is('admin/faqs*') || Request::is('admin/policies*') ? 'active open' : ''); ?>">
                <a href="javascript:void(0);" class="menu-link menu-toggle">
                ...
                <ul class="menu-sub">
                    ...
                    ?>
                    <?php if(auth('admin')->user()->isSuperAdmin() || auth('admin')->user()->hasAnyPermission($faqPermissions)): ?>
                        <li class="menu-item <?php echo e(Request::is('admin/faqs*') ? 'active open' : ''); ?>">
                            <a href="javascript:void(0);" class="menu-link menu-toggle">
                                <i class="menu-icon tf-icons ti ti-help"></i>
                                <div data-i18n="FAQ">FAQ</div>
                            </a>
                            <ul class="menu-sub">
                                <?php if(auth('admin')->user()->isSuperAdmin() || auth('admin')->user()->hasAnyPermission(['website.faqs-pricing.view', 'website.faqs-pricing.create', 'website.faqs-pricing.edit', 'website.faqs-pricing.delete'])): ?>
                                    <li class="menu-item <?php echo e(Request::is('admin/faqs/pricing*') ? 'active' : ''); ?>">
                                        <a href="<?php echo e(route('admin.faqs.pricing.index')); ?>" class="menu-link">
                                            <div data-i18n="Pricing">Pricing</div>
                                        </a>
                                    </li>
                                <?php endif; ?>

                                <?php if(auth('admin')->user()->isSuperAdmin() || auth('admin')->user()->hasAnyPermission(['website.faqs-subscription.view', 'website.faqs-subscription.create', 'website.faqs-subscription.edit', 'website.faqs-subscription.delete'])): ?>
                                    <li class="menu-item <?php echo e(Request::is('admin/faqs/subscription*') ? 'active' : ''); ?>">
                                        <a href="<?php echo e(route('admin.faqs.subscription.index')); ?>" class="menu-link">
                                            <div data-i18n="Subscription">Subscription & Membership</div>
                                        </a>
                                    </li>
                                <?php endif; ?>

                                <?php if(auth('admin')->user()->isSuperAdmin() || auth('admin')->user()->hasAnyPermission(['website.faqs-payment.view', 'website.faqs-payment.create', 'website.faqs-payment.edit', 'website.faqs-payment.delete'])): ?>
                                    <li class="menu-item <?php echo e(Request::is('admin/faqs/payment*') ? 'active' : ''); ?>">
                                        <a href="<?php echo e(route('admin.faqs.payment.index')); ?>" class="menu-link">
                                            <div data-i18n="Payment">Payments & Transactions</div>
                                        </a>
                                    </li>
                                <?php endif; ?>

                                <?php if(auth('admin')->user()->isSuperAdmin() || auth('admin')->user()->hasAnyPermission(['website.faqs-ebook-access.view', 'website.faqs-ebook-access.create', 'website.faqs-ebook-access.edit', 'website.faqs-ebook-access.delete'])): ?>
                                    <li class="menu-item <?php echo e(Request::is('admin/faqs/ebook-access*') ? 'active' : ''); ?>">
                                        <a href="<?php echo e(route('admin.faqs.ebook-access.index')); ?>" class="menu-link">
                                            <div data-i18n="EbookAccess">eBook Access & Reading</div>
                                        </a>
                                    </li>
                                <?php endif; ?>

                                <?php if(auth('admin')->user()->isSuperAdmin() || auth('admin')->user()->hasAnyPermission(['website.faqs-support.view', 'website.faqs-support.create', 'website.faqs-support.edit', 'website.faqs-support.delete'])): ?>
                                    <li class="menu-item <?php echo e(Request::is('admin/faqs/support*') ? 'active' : ''); ?>">
                                        <a href="<?php echo e(route('admin.faqs.support.index')); ?>" class="menu-link">
                                            <div data-i18n="Support">Account & Technical Support</div>
                                        </a>
                                    </li>
                                <?php endif; ?>

                                <?php if(auth('admin')->user()->isSuperAdmin() || auth('admin')->user()->hasAnyPermission(['website.faqs-content.view', 'website.faqs-content.create', 'website.faqs-content.edit', 'website.faqs-content.delete'])): ?>
                                    <li class="menu-item <?php echo e(Request::is('admin/faqs/content*') ? 'active' : ''); ?>">
                                        <a href="<?php echo e(route('admin.faqs.content.index')); ?>" class="menu-link">
                    ...
                    ?>
                    <?php if(auth('admin')->user()->isSuperAdmin() || auth('admin')->user()->hasAnyPermission($policyPermissions)): ?>
                        <li class="menu-item <?php echo e(Request::is('admin/policies*') ? 'active open' : ''); ?>">
                            <a href="javascript:void(0);" class="menu-link menu-toggle">
                                <i class="menu-icon tf-icons ti ti-file-text"></i>
                                <div data-i18n="Policy">Policy</div>
                            </a>
                            <ul class="menu-sub">
                                <?php if(auth('admin')->user()->isSuperAdmin() || auth('admin')->user()->hasAnyPermission(['website.policies-help.view', 'website.policies-help.create', 'website.policies-help.edit', 'website.policies-help.delete'])): ?>
                                    <li class="menu-item <?php echo e(Request::is('admin/policies/help*') ? 'active' : ''); ?>">
                                        <a href="<?php echo e(route('admin.policies.help.index')); ?>" class="menu-link">
                                            <div data-i18n="HelpCenter">Help Center</div>
                                        </a>
                                    </li>
                                <?php endif; ?>

                                <?php if(auth('admin')->user()->isSuperAdmin() || auth('admin')->user()->hasAnyPermission(['website.policies-privacy.view', 'website.policies-privacy.create', 'website.policies-privacy.edit', 'website.policies-privacy.delete'])): ?>
                                    <li class="menu-item <?php echo e(Request::is('admin/policies/privacy*') ? 'active' : ''); ?>">
                                        <a href="<?php echo e(route('admin.policies.privacy.index')); ?>" class="menu-link">
                                            <div data-i18n="PrivacyPolicy">Privacy Policy</div>
                                        </a>
                                    </li>
                                <?php endif; ?>

                                <?php if(auth('admin')->user()->isSuperAdmin() || auth('admin')->user()->hasAnyPermission(['website.policies-terms.view', 'website.policies-terms.create', 'website.policies-terms.edit', 'website.policies-terms.delete'])): ?>
                                    <li class="menu-item <?php echo e(Request::is('admin/policies/terms*') ? 'active' : ''); ?>">
                                        <a href="<?php echo e(route('admin.policies.terms.index')); ?>" class="menu-link">
                                            <div data-i18n="TermsConditions">Terms & Conditions</div>
                                        </a>
                                    </li>
                                <?php endif; ?>

                                <?php if(auth('admin')->user()->isSuperAdmin() || auth('admin')->user()->hasAnyPermission(['website.policies-shopping.view', 'website.policies-shopping.create', 'website.policies-shopping.edit', 'website.policies-shopping.delete'])): ?>
                                    <li class="menu-item <?php echo e(Request::is('admin/policies/shopping*') ? 'active' : ''); ?>">
                                        <a href="<?php echo e(route('admin.policies.shopping.index')); ?>" class="menu-link">
                                            <div data-i18n="ShoppingPolicy">Shopping Policy</div>
                                        </a>
                                    </li>
                                <?php endif; ?>

                                <?php if(auth('admin')->user()->isSuperAdmin() || auth('admin')->user()->hasAnyPermission(['website.policies-payment.view', 'website.policies-payment.create', 'website.policies-payment.edit', 'website.policies-payment.delete'])): ?>
                                    <li class="menu-item <?php echo e(Request::is('admin/policies/payment*') ? 'active' : ''); ?>">
                                        <a href="<?php echo e(route('admin.policies.payment.index')); ?>" class="menu-link">
        ...
        <!-- Reports -->
        <li class="menu-item <?php echo e(Request::is('admin/reports*') ? 'active open' : ''); ?>">
            <a href="javascript:void(0);" class="menu-link menu-toggle">
                <i class="menu-icon tf-icons ti ti-report-analytics"></i>
                <div data-i18n="Reports"><?php echo e(__('admin.menu.reports')); ?></div>
            </a>
            <ul class="menu-sub">
                <!-- <li class="menu-item <?php echo e(Request::is('admin/reports') && !Request::is('admin/reports/*') ? 'active' : ''); ?>">
                    <a href="<?php echo e(route('admin.reports.index')); ?>" class="menu-link">
                        <div data-i18n="Overview"><?php echo e(__('admin.menu.reports_overview')); ?></div>
                    </a>
                </li> -->
                <li class="menu-item <?php echo e(Request::is('admin/reports/revenue') ? 'active' : ''); ?>">
                    <a href="<?php echo e(route('admin.reports.revenue')); ?>" class="menu-link">
                        <div data-i18n="Revenue Report"><?php echo e(__('admin.menu.revenue_report')); ?></div>
                    </a>
                </li>
                <li class="menu-item <?php echo e(Request::is('admin/reports/ebook-performance') ? 'active' : ''); ?>">
                    <a href="<?php echo e(route('admin.reports.ebook-performance')); ?>" class="menu-link">
                        <div data-i18n="Ebook Performance"><?php echo e(__('admin.menu.ebook_performance')); ?></div>
                    </a>
                </li>
                <li class="menu-item <?php echo e(Request::is('admin/reports/user-analytics') ? 'active' : ''); ?>">
                    <a href="<?php echo e(route('admin.reports.user-analytics')); ?>" class="menu-link">
                        <div data-i18n="User Analytics"><?php echo e(__('admin.menu.user_analytics')); ?></div>
                    </a>
                </li>
                <li class="menu-item <?php echo e(Request::is('admin/reports/subscription-analytics') ? 'active' : ''); ?>">
                    <a href="<?php echo e(route('admin.reports.subscription-analytics')); ?>" class="menu-link">
                        <div data-i18n="Subscription Analytics"><?php echo e(__('admin.menu.subscription_analytics')); ?></div>
                    </a>
                </li>
            </ul>
        </li>
    </ul>
</aside><?php /**PATH C:\laragon\www\ebook_traveling\resources\views/layouts/partials/admin/sidebar.blade.php ENDPATH**/ ?>