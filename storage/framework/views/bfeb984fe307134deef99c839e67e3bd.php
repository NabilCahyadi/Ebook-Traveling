<?php $__env->startSection('title', __('admin.cities.title')); ?>
    ...
    <div class="container-xxl flex-grow-1 container-p-y">
        ...
        <div class="d-flex flex-column flex-md-row justify-content-between align-items-start align-items-md-center mb-4 gap-3">
            <div>
                <h4 class="fw-bold py-3 mb-2">
                    <span class="text-muted fw-light"><?php echo e(__('admin.menu.master_data')); ?> /</span> <?php echo e(__('admin.cities.title')); ?>
            ...
            <div class="d-flex flex-wrap gap-2">
                ...
                <div class="btn-group" role="group">
                    <button type="button" class="btn btn-outline-primary" id="cardViewBtn" onclick="switchView('card')">
                        <i class="ti ti-layout-grid me-1"></i> <span class="d-none d-sm-inline"><?php echo e(__('admin.cities.cards_view')); ?></span>
                    </button>
                    <button type="button" class="btn btn-outline-primary" id="tableViewBtn" onclick="switchView('table')">
                        <i class="ti ti-table me-1"></i> <span class="d-none d-sm-inline"><?php echo e(__('admin.cities.table_view')); ?></span>
                    </button>
                </div>
                <button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#createModal">
                    <i class="ti ti-plus me-1"></i> <span class="d-none d-sm-inline"><?php echo e(__('admin.cities.add_city')); ?></span>
                </button>
            </div>
        </div>
                    ...
                    <div class="row g-3">
                        <div class="col-12 col-md-4">
                            ...
                            <input type="text" class="form-control" id="search" name="search"
                                value="<?php echo e(request('search')); ?>" placeholder="<?php echo e(__('admin.cities.search_placeholder')); ?>">
                        </div>
                        <div class="col-6 col-md-3">
                            <label for="province" class="form-label"><?php echo e(__('admin.cities.filter_province')); ?></label>
                            <select class="form-select" id="province" name="province">
                                <option value=""><?php echo e(__('admin.cities.all_provinces')); ?></option>
                        ...
                        <div class="col-6 col-md-2">
                            <label for="sort_by" class="form-label"><?php echo e(__('admin.cities.sort_by')); ?></label>
                            <select class="form-select" id="sort_by" name="sort_by">
                                <option value="created_at" <?php echo e(request('sort_by') == 'created_at' ? 'selected' : ''); ?>><?php echo e(__('admin.cities.date')); ?>

                                </option>
                                <option value="name" <?php echo e(request('sort_by') == 'name' ? 'selected' : ''); ?>><?php echo e(__('admin.form.name')); ?></option>
                                <option value="province" <?php echo e(request('sort_by') == 'province' ? 'selected' : ''); ?>><?php echo e(__('admin.cities.province')); ?>

                                </option>
                            </select>
                        </div>
                        <div class="col-6 col-md-2">
                            <label for="sort_order" class="form-label"><?php echo e(__('admin.cities.order')); ?></label>
                            <select class="form-select" id="sort_order" name="sort_order">
                                <option value="asc" <?php echo e(request('sort_order') == 'asc' ? 'selected' : ''); ?>><?php echo e(__('admin.cities.ascending')); ?>

                                </option>
                                <option value="desc" <?php echo e(request('sort_order') == 'desc' ? 'selected' : ''); ?>><?php echo e(__('admin.cities.descending')); ?>
                        ...
                        <?php if(request()->hasAny(['search', 'province', 'sort_by', 'sort_order'])): ?>
                            <div class="col-12">
                                <a href="<?php echo e(route('admin.cities.index')); ?>" class="btn btn-label-secondary">
                                    <i class="ti ti-x me-1"></i> <?php echo e(__('admin.cities.clear_filters')); ?>
        ...
        <?php if($cities->count() > 0): ?>
            <div class="mb-3 d-flex flex-column flex-md-row justify-content-between align-items-start align-items-md-center gap-2">
                <div class="text-muted"><?php echo e(__('admin.common.total')); ?>: <?php echo e($cities->total()); ?> <?php echo e(__('admin.cities.title')); ?></div>
                <div class="text-muted">
                    <?php echo e(__('admin.common.showing_results', ['from' => $cities->firstItem(), 'to' => $cities->lastItem(), 'total' => $cities->total()])); ?>
                    ...
                    <div class="col-md-6 col-lg-4 col-xl-3">
                        <div class="card h-100 shadow-sm">
                            ...
                            <div class="position-relative"
                                        ...
                                        <ul class="dropdown-menu dropdown-menu-end">
                                            <li>
                                                <a class="dropdown-item" href="javascript:void(0);"
                                                    onclick="editCity('<?php echo e($city->id); ?>', '<?php echo e($city->name); ?>', '<?php echo e($city->province); ?>', '<?php echo e($city->image_url); ?>')">
                                                    <i class="ti ti-pencil me-2"></i> <?php echo e(__('admin.common.edit')); ?>
                                            ...
                                            <li>
                                                <form action="<?php echo e(route('admin.cities.destroy', $city->id)); ?>"
                                                    method="POST"
                                                    onsubmit="return confirm('<?php echo e(__('admin.messages.confirm_delete')); ?>');">
                                                    <?php echo csrf_field(); ?>
                                ...
                                <!-- City Image -->
                                <img src="<?php echo e($city->image_url); ?>" alt="<?php echo e($city->name); ?>"
                ...
                <div class="card-body">
                    <div class="table-responsive">
                        <table class="table table-hover">
                            <thead>
                                <tr>
                                    <th><?php echo e(__('admin.cities.city_name')); ?></th>
                                    <th><?php echo e(__('admin.cities.province')); ?></th>
                                    <th class="d-none d-md-table-cell"><?php echo e(__('admin.common.date_created')); ?></th>
        ...
        <?php else: ?>
            <div class="card">
                <div class="card-body text-center py-5">
                    ...
                    <h5 class="text-muted"><?php echo e(__('admin.cities.no_cities')); ?></h5>
                    <p class="text-muted"><?php echo e(__('admin.common.try_adjusting_filters')); ?></p>
                    <button type="button" class="btn btn-primary mt-2" data-bs-toggle="modal"
                        data-bs-target="#createModal">
                        <i class="ti ti-plus me-1"></i> <?php echo e(__('admin.cities.add_city')); ?>
            ...
            <div class="modal-content">
                <form action="<?php echo e(route('admin.cities.store')); ?>" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="modal-header">
                        <h5 class="modal-title"><?php echo e(__('admin.cities.add_city')); ?></h5>
                        <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                    </div>
                    <div class="modal-body">
                        <div class="mb-3">
                            <label for="name" class="form-label"><?php echo e(__('admin.cities.city_name')); ?> <span class="text-danger">*</span></label>
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="mb-3">
                            <label for="province" class="form-label"><?php echo e(__('admin.cities.province')); ?> <span class="text-danger">*</span></label>
...
unset($__errorArgs, $__bag); ?>"
                                ...
                                placeholder="<?php echo e(__('admin.cities.province_placeholder')); ?>" required>
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="mb-3">
                            <label for="cityImageInput" class="form-label"><?php echo e(__('admin.cities.city_image')); ?></label>
...
unset($__errorArgs, $__bag); ?>"
                            ...
                            <small class="text-muted"><?php echo e(__('admin.cities.image_hint')); ?></small>
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div id="cityPreviewArea" style="display: none;" class="mb-3">
                            <label class="form-label"><?php echo e(__('admin.cities.preview')); ?></label>
                            ...
                            <button type="button" class="btn btn-sm btn-outline-secondary mt-2"
                                ...
                                <i class="ti ti-x me-1"></i> <?php echo e(__('admin.actions.remove')); ?>
                    ...
                    <div class="modal-footer">
                        <button type="button" class="btn btn-secondary" data-bs-dismiss="modal"><?php echo e(__('admin.actions.cancel')); ?></button>
                        <button type="submit" class="btn btn-primary">
                            <i class="ti ti-device-floppy me-1"></i> <?php echo e(__('admin.cities.create_city')); ?>
        ...
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                <form id="editForm" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="modal-header">
                        <h5 class="modal-title"><?php echo e(__('admin.cities.edit_city')); ?></h5>
                        <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                    </div>
                    <div class="modal-body">
                        <div class="mb-3">
                            <label for="edit_name" class="form-label"><?php echo e(__('admin.cities.city_name')); ?> <span
                                    class="text-danger">*</span></label>
                            <input type="text" class="form-control" id="edit_name" name="name"
                                placeholder="<?php echo e(__('admin.cities.name_placeholder')); ?>" required>
                        </div>
                        <div class="mb-3">
                            <label for="edit_province" class="form-label"><?php echo e(__('admin.cities.province')); ?> <span
                                    class="text-danger">*</span></label>
                            <input type="text" class="form-control" id="edit_province" name="province"
                                placeholder="<?php echo e(__('admin.cities.province_placeholder')); ?>" required>
                        </div>
                        <div class="mb-3">
                            <label class="form-label"><?php echo e(__('admin.cities.current_image')); ?></label>
                            <div id="edit_current_image" class="mb-2">
                                <!-- Will be populated by JavaScript -->
                            </div>
                        </div>
                        <div class="mb-3">
                            <label for="editCityImageInput" class="form-label"><?php echo e(__('admin.cities.change_image')); ?></label>
                    ...
                    <div class="modal-footer">
                        <button type="button" class="btn btn-secondary" data-bs-dismiss="modal"><?php echo e(__('admin.actions.cancel')); ?></button>
                        <button type="submit" class="btn btn-primary">
                            <i class="ti ti-device-floppy me-1"></i> <?php echo e(__('admin.cities.update_city')); ?>
