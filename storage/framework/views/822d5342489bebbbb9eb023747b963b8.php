...
<head>
    ...
    <title><?php echo e($ebook->title); ?> - Ebook Reader</title>
    ...
    <style>
        ...
        * {
        ...
        .reader-content::before {
            content: '<?php echo e(Auth::user()->email); ?> - <?php echo e(now()->format(' Y-m-d H: i')); ?>';
            position: absolute;
            top: 50%;
            left: 50%;
...
<body>
    ...
    <script>
        ...
        const readerToken = '<?php echo e(Str::random(32)); ?>';
            ...
            setTimeout(() => {
                const content = `
                    <div class="content-text" id="content-text">
                        <h2><?php echo e($ebook->title); ?></h2>
                        <p style="color: #666; margin: 1rem 0;">
                            <strong>Category:</strong> <?php echo e($ebook->category->name ?? 'N/A'); ?> |
                            <strong>Location:</strong> <?php echo e($ebook->city->name ?? 'N/A'); ?>

                        </p>
                        <hr style="margin: 2rem 0; border: none; border-top: 1px solid #eee;">

                        <div style="white-space: pre-line;"><?php echo e($ebook->preview_content ?? $ebook->description); ?></div>
    ...
    <script>
        ...
        function saveReadingProgress() {
            ...
            fetch(`/user/api/ebook/<?php echo e($ebook->id); ?>/progress`, {
                method: 'POST',
                headers: {
                    'Content-Type': 'application/json',
                    'X-CSRF-TOKEN': document.querySelector('meta[name="csrf-token"]').content
...
</html><?php /**PATH D:\PROJEK PROJEK\Ebook-Traveling\resources\views/user/ebook-reader.blade.php ENDPATH**/ ?>