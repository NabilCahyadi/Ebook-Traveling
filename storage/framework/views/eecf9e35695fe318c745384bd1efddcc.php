...
<head>
    ...
    <title>Forgot Password - Admin MeatMap</title>
    <meta name="description" content="Admin Forgot Password" />
            ...
            <div class="authentication-inner py-4">
                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <form id="formForgotPassword" class="mb-3" action="<?php echo e(route('admin.password.send-code')); ?>"
                            method="POST">
                            <?php echo csrf_field(); ?>
                            <div class="mb-3">
...
<?php /**PATH C:\laragon\www\ebook_traveling\resources\views\admin\auth\forgot-password.blade.php ENDPATH**/ ?>