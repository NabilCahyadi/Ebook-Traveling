        ...
        <div class="row align-items-center">
            <div class="col-lg-8">
                <h4 class="mb-0">
                    <?php if($ebooks->total() > 0): ?>
                        Found <span class="text-brand"><?php echo e($ebooks->total()); ?></span> result(s) for "<strong><?php echo e($query); ?></strong>"
                    <?php else: ?>
            ...
            <div class="col-lg-4 text-end">
                <form action="<?php echo e(route('search')); ?>" method="GET" class="d-inline-flex gap-2 w-100">
                    <input type="text" name="q" value="<?php echo e($query); ?>" class="form-control" placeholder="Try another search...">
                ...
                <div class="col-lg-1-5 col-md-4 col-12 col-sm-6">
                    <div class="product-cart-wrap mb-30 wow animate__animated animate__fadeIn" data-wow-delay="<?php echo e(($index + 1) * 0.1); ?>s">
                        ...
                        <div class="product-content-wrap">
                            ...
                            <p class="product-description"><?php echo e(Str::limit(strip_tags($ebook->short_description ?? $ebook->description), 75)); ?></p>

                            
                            <?php if(auth()->guard()->check()): ?>
                                <?php if(auth()->user()->hasActiveSubscription() || $ebook->is_free): ?>
                                    <a href="<?php echo e(route('reader.show', $ebook->slug)); ?>" class="action-btn btn-read-now">
