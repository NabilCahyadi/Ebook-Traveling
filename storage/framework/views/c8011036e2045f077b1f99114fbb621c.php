<?php $__env->startSection('title', 'Creator Dashboard'); ?>
    ...
    <div class="container-fluid">
        ...
        <div class="row">
            <div class="col-12">
                <div class="card">
                    <div class="card-body">
                        <h5 class="card-title mb-3">Welcome, <?php echo e(auth()->user()->name); ?>!</h5>
                        <p class="text-muted">
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\ebook_traveling\resources\views\creator\dashboard.blade.php ENDPATH**/ ?>