        ...
        <div class="card">
            <div class="card-header">
                ...
                <form method="GET" action="<?php echo e(route('admin.blogs.index')); ?>" class="row g-3">
                    <div class="col-md-3">
                        ...
                        <select class="form-select" id="status" name="status">
                            ...
                            <option value="unpublished" <?php echo e($status == 'unpublished' ? 'selected' : ''); ?>>Unpublished
                            </option>
                        </select>
                    </div>
                    <div class="col-md-3">
                    ...
                    <div class="col-md-4">
                        ...
                        <input type="text" class="form-control" id="search" name="search"
                            placeholder="Search by title, content..." value="<?php echo e($search ?? ''); ?>">
                    </div>
                    <div class="col-md-2">
                ...
                <div class="d-flex justify-content-between align-items-center mt-3">
                    <span class="badge bg-primary"><?php echo e($blogs->total()); ?> Total</span>
