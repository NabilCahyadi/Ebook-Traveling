    ...
    <div class="container">
        ...
        <div class="row mt-5">
            ...
            <div class="col-lg-3 col-md-4 col-sm-6">
                ...
                <a href="<?php echo e(route('destination.show', $city->slug)); ?>" class="text-decoration-none destination-link">
                    <div class="destination-card position-relative overflow-hidden" style="height: 250px; border-radius: 12px;">
                        <!-- Gambar sebagai background -->
                        <div class="destination-thumb" style="background-image: url('<?php echo e(asset($city->image)); ?>'); height: 100%; background-size: cover; background-position: center;"></div>
                        ...
                        <div class="destination-content position-absolute bottom-0 start-0 w-100 p-3 text-center">
                            <div class="destination-title text-white fw-bold fs-5"><?php echo e($city->name); ?></div>
                        </div>
                    </div>
                </a>
            </div>
