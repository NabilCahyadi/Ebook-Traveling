<?php $__env->startSection('title', __('admin.collections.create_new')); ?>
    ...
    <div class="container-xxl flex-grow-1 container-p-y">
        ...
        <div class="mb-4">
            <h4 class="fw-bold py-3 mb-2">
                <span class="text-muted fw-light">
                    <a href="<?php echo e(route('admin.collections.index')); ?>" class="text-muted"><?php echo e(__('admin.website_settings')); ?></a> / 
                    <a href="<?php echo e(route('admin.collections.index')); ?>" class="text-muted"><?php echo e(__('admin.collections.title')); ?></a> /
                </span> 
                <?php echo e(__('admin.collections.create_new')); ?>
        ...
        <?php if($errors->any()): ?>
            <div class="alert alert-danger alert-dismissible fade show" role="alert">
                <strong><?php echo e(__('admin.collections.validation_error')); ?></strong>
                <ul class="mb-0 mt-2">
        ...
        <div class="card mb-4">
            <div class="card-header d-flex justify-content-between align-items-center">
                <h5 class="mb-0"><?php echo e(__('admin.collections.collection_information')); ?></h5>
            </div>
            <div class="card-body">
                <form id="collection-form" action="<?php echo e(url('/admin/collections')); ?>" method="POST" data-route="<?php echo e(route('admin.collections.store')); ?>" onsubmit="console.log('Form onsubmit triggered');">
                    <?php echo csrf_field(); ?>
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <!-- Name -->
                            <div class="mb-3">
                                <label class="form-label" for="name"><?php echo e(__('admin.collections.collection_name')); ?> <span class="text-danger">*</span></label>
...
unset($__errorArgs, $__bag); ?>
                            ...
                            <!-- Slug -->
                            <div class="mb-3">
                                <label class="form-label" for="slug"><?php echo e(__('admin.collections.slug')); ?></label>
...
unset($__errorArgs, $__bag); ?>" 
                                ...
                                <small class="form-text text-muted"><?php echo e(__('admin.collections.slug_hint')); ?></small>
...
unset($__errorArgs, $__bag); ?>
                            ...
                            <!-- Order -->
                            <div class="mb-3">
                                <label class="form-label" for="order"><?php echo e(__('admin.collections.display_order')); ?></label>
...
unset($__errorArgs, $__bag); ?>" 
                                ...
                                <small class="form-text text-muted"><?php echo e(__('admin.collections.order_hint')); ?></small>
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="col-md-6">
                            <!-- Description -->
                            <div class="mb-3">
                                <label class="form-label" for="description"><?php echo e(__('admin.collections.description')); ?></label>
...
unset($__errorArgs, $__bag); ?>" 
                                          ...
                                          placeholder="<?php echo e(__('admin.collections.description_placeholder')); ?>"><?php echo e(old('description')); ?></textarea>
...
unset($__errorArgs, $__bag); ?>
                            ...
                            <!-- Status Checkboxes -->
                            <div class="mb-3">
                                <label class="form-label d-block"><?php echo e(__('admin.collections.visibility_settings')); ?></label>
                                
                                <div class="form-check form-switch">
                                    <input class="form-check-input" type="checkbox" id="is_active" 
                                           name="is_active" value="1" <?php echo e(old('is_active', true) ? 'checked' : ''); ?>>
                                    <label class="form-check-label" for="is_active">
                                        <?php echo e(__('admin.collections.active')); ?>

                                        <small class="text-muted d-block"><?php echo e(__('admin.collections.active_hint')); ?></small>
                                    </label>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="d-flex justify-content-between">
                        <a href="<?php echo e(route('admin.collections.index')); ?>" class="btn btn-label-secondary">
                            <i class="ti ti-arrow-left me-1"></i> <?php echo e(__('admin.collections.cancel')); ?>

                        </a>
                        <button type="button" class="btn btn-primary" id="btn-submit">
                            <i class="ti ti-device-floppy me-1"></i> <?php echo e(__('admin.collections.create_collection')); ?>
        ...
        <div class="row">
            <div class="col-12">
                <div class="card">
                    <div class="card-header d-flex justify-content-between align-items-center">
                        <h5 class="mb-0">
                            <i class="ti ti-books me-2"></i><?php echo e(__('admin.collections.select_ebooks')); ?>

                        </h5>
                        <span class="badge bg-label-primary" id="selected-count-badge"><?php echo e(__('admin.collections.selected_count', ['count' => 0])); ?></span>
                    </div>
                    <div class="card-body">
                        <!-- Filters -->
                        <div class="row mb-3">
                            <div class="col-md-3">
                                <label class="form-label"><?php echo e(__('admin.collections.search')); ?></label>
                                <input type="text" id="filter-search" class="form-control" placeholder="<?php echo e(__('admin.collections.search_placeholder')); ?>">
                            </div>
                            <div class="col-md-3">
                                <label class="form-label"><?php echo e(__('admin.collections.category')); ?></label>
                            ...
                            <div class="col-md-3">
                                <label class="form-label"><?php echo e(__('admin.collections.sort_by')); ?></label>
                                <select id="filter-sort" class="form-select">
                                    <option value="created_at_desc"><?php echo e(__('admin.collections.newest_first')); ?></option>
                                    <option value="created_at_asc"><?php echo e(__('admin.collections.oldest_first')); ?></option>
                                    <option value="view_count_desc"><?php echo e(__('admin.collections.most_viewed')); ?></option>
                                    <option value="view_count_asc"><?php echo e(__('admin.collections.least_viewed')); ?></option>
                                    <option value="title_asc"><?php echo e(__('admin.collections.title_asc')); ?></option>
                                    <option value="title_desc"><?php echo e(__('admin.collections.title_desc')); ?></option>
                                </select>
                            </div>
                            <div class="col-md-3">
                                <label class="form-label">&nbsp;</label>
                                <div class="text-muted small">
                                    <?php echo e(__('admin.collections.select_hint')); ?>
...
<script>
    ...
    document.addEventListener('DOMContentLoaded', function() {
        ...
        document.getElementById('btn-submit').addEventListener('click', function(e) {
            ...
            const correctAction = '<?php echo e(url("/admin/collections")); ?>';
    ...
    function updateSelectedCount() {
        ...
        const text = '<?php echo e(__("admin.collections.selected_count", ["count" => "COUNT_PLACEHOLDER"])); ?>'.replace('COUNT_PLACEHOLDER', count);
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\ebook_traveling\resources\views\admin\collections\create.blade.php ENDPATH**/ ?>