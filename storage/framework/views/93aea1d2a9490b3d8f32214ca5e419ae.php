...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="mb-3">
                            <label for="creator_search" class="form-label"><?php echo e(__('admin.ebooks.creator')); ?> <span class="text-danger">*</span></label>
                            <input type="text" 
...
unset($__errorArgs, $__bag); ?>" id="status"
                                    ...
                                    <option value="archived"
                                        <?php echo e(old('status', $ebook->status) == 'archived' ? 'selected' : ''); ?>><?php echo e(__('admin.ebooks.archived')); ?>
