<?php $__env->startSection('title', __('admin.blogs.trash') . ' - ' . __('admin.blogs.title')); ?>

<?php $__env->startSection('content'); ?>
    <div class="container-xxl flex-grow-1 container-p-y">
        <div class="d-flex justify-content-between align-items-center mb-4">
            <h4 class="fw-bold py-3 mb-0">
                <span class="text-muted fw-light">Admin / <?php echo e(__('admin.blogs.title')); ?> /</span> <?php echo e(__('admin.blogs.trash')); ?>

            </h4>
            <div class="d-flex gap-2">
                <a href="<?php echo e(route('admin.blogs.index')); ?>" class="btn btn-outline-secondary">
                    <i class="ti ti-arrow-left me-1"></i> <?php echo e(__('admin.blogs.back_to_all')); ?>
        ...
        <div class="card">
            <div class="card-header">
                <div class="row align-items-center">
                    <div class="col-md-3">
                        <h5 class="mb-0"><i class="ti ti-trash me-2"></i><?php echo e(__('admin.blogs.trash_blogs')); ?></h5>
                        <small class="text-muted"><?php echo e(__('admin.blogs.trash_description')); ?></small>
                    </div>
                    <div class="col-md-9">
                ...
                <div class="row align-items-center mt-3">
                    <div class="col-md-12">
                        <div class="input-group">
                            ...
                            <input type="text" class="form-control" placeholder="<?php echo e(__('admin.blogs.search_trash')); ?>" id="searchBlog">
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div id="tableView" class="table-responsive text-nowrap">
                <table class="table table-hover align-middle">
                    <thead style="background-color: #fff; border-bottom: 2px solid #dee2e6;">
                        <tr>
                            <th style="width: 60px; color: #566a7f; font-weight: 600;"><?php echo e(__('admin.blogs.image')); ?></th>
                            <th style="width: 35%; color: #566a7f; font-weight: 600;"><?php echo e(__('admin.blogs.blog_title')); ?></th>
                            <th style="width: 15%; color: #566a7f; font-weight: 600;"><?php echo e(__('admin.blogs.author')); ?></th>
                            <th style="width: 15%; color: #566a7f; font-weight: 600;"><?php echo e(__('admin.blogs.deleted_at')); ?></th>
                            <th style="width: 80px; text-align: center; color: #566a7f; font-weight: 600;"><?php echo e(__('admin.blogs.actions')); ?></th>
                        </tr>
                    </thead>
                            ...
                            <tr style="height: 60px;">
                                <td class="py-2">
                                    <?php if($blog->featured_image_url): ?>
                                        <img src="<?php echo e($blog->featured_image_url); ?>" alt="<?php echo e($blog->title); ?>"
                                ...
                                <td class="py-2">
                                    <div style="max-width: 300px;">
                                        <strong class="d-block mb-0"
                                            ...
                                            title="<?php echo e($blog->title); ?>"><?php echo e($blog->title); ?></strong>
                                        <small class="text-muted d-block"
                                            style="font-size: 0.75rem; overflow: hidden; text-overflow: ellipsis; white-space: nowrap;"
                                            title="<?php echo e(strip_tags($blog->excerpt ?? $blog->content)); ?>"><?php echo e(strip_tags($blog->excerpt ?? $blog->content)); ?></small>
                                    </div>
                                </td>
                                <td class="py-2">
                                    <div style="max-width: 120px; overflow: hidden; text-overflow: ellipsis; white-space: nowrap; font-size: 0.85rem;"
                                        title="<?php echo e($blog->author->name ?? '-'); ?>"><?php echo e($blog->author->name ?? '-'); ?></div>
                                </td>
                                <td class="py-2">
                                    <small class="text-muted"><?php echo e($blog->deleted_at ? $blog->deleted_at->format('d M Y') : '-'); ?></small>
                                </td>
                                <td class="py-2 text-center">
                                    <div class="dropdown d-inline-block">
                                        ...
                                        <div class="dropdown-menu dropdown-menu-end">
                                            <form action="<?php echo e(route('admin.blogs.restore', $blog->id)); ?>" method="POST" style="display: inline;">
                                                <?php echo csrf_field(); ?>
                                                <button type="submit" class="dropdown-item" 
                                                    onclick="return confirm('<?php echo e(__('admin.blogs.restore_confirm')); ?>')">
                                                    <i class="ti ti-refresh me-2"></i> <?php echo e(__('admin.blogs.restore')); ?>

                                                </button>
                                            </form>
                                            <div class="dropdown-divider"></div>
                                            <form action="<?php echo e(route('admin.blogs.force-delete', $blog->id)); ?>" method="POST" style="display: inline;">
                                                <?php echo csrf_field(); ?>
                                                <?php echo method_field('DELETE'); ?>
                                                <button type="submit" class="dropdown-item text-danger" 
                                                    onclick="return confirm('<?php echo e(__('admin.blogs.delete_permanent_confirm')); ?>')">
                                                    <i class="ti ti-trash-x me-2"></i> <?php echo e(__('admin.blogs.delete_permanent')); ?>
                        ...
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?>
                            <tr>
                                <td colspan="5" class="text-center py-5">
                                    ...
                                    <p class="mt-2 text-muted"><?php echo e(__('admin.blogs.trash_empty')); ?></p>
                                </td>
                            </tr>
                        <?php endif; ?>
                    </tbody>
                        ...
                        <div class="col-md-6 col-lg-4 col-xl-3">
                            <div class="card h-100 shadow-sm d-flex flex-column border-danger position-relative">
                                ...
                                <div style="background-color: #fff;" class="p-2 rounded">
                                    <?php if($blog->featured_image_url): ?>
                                        <img src="<?php echo e($blog->featured_image_url); ?>" class="card-img-top rounded"
                                            alt="<?php echo e($blog->title); ?>" style="height: 250px; object-fit: cover;"
                                            onerror="this.onerror=null; this.style.display='none'; this.nextElementSibling.style.display='flex';">
                                        <div class="bg-label-secondary rounded align-items-center justify-content-center"
                                ...
                                <div class="card-body d-flex flex-column">
                                    <div class="mb-2">
                                        <h5 class="card-title mb-1"><?php echo e(Str::limit($blog->title, 30)); ?></h5>
                                        <span class="badge bg-danger"><?php echo e(__('admin.blogs.trash')); ?></span>
                                    </div>
                                    <p class="card-text small text-muted mb-3"
                                        style="flex-grow: 1; overflow: hidden; display: -webkit-box; -webkit-line-clamp: 3; -webkit-box-orient: vertical;">
                                        <?php echo e(Str::limit(strip_tags($blog->excerpt ?? $blog->content), 100)); ?></p>
                                    ...
                                    <div class="mt-auto pt-2">
                                        <div class="d-flex justify-content-between align-items-center">
                                            <small class="text-muted">
                                                ...
                                                <?php echo e($blog->deleted_at ? $blog->deleted_at->diffForHumans() : '-'); ?>
            ...
            <?php if($blogs->hasPages()): ?>
                <div class="card-footer">
                    <?php echo e($blogs->appends(['per_page' => request('per_page', 10)])->links()); ?>
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\ebook_traveling\resources\views\admin\blogs\trash.blade.php ENDPATH**/ ?>