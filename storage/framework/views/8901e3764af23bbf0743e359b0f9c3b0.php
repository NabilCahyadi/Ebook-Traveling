...
<body>
        ...
        <div id="pdf-controls">
            ...
            <div class="bookmark-info-container">
                <div class="bookmark-info">
                    <span>Last : Pg. <?php echo e($startPage ?? 1); ?></span>
                </div>
            </div>
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            ...
            const updateUrl = '<?php echo e(route("user.reader.updateProgress")); ?>';
    ...
    <script>
        ...
        // --- Variabel Utama ---
        const url = "<?php echo e(Storage::url($ebook->pdf_file)); ?>";
        let pdfDoc = null,
            pageNum = 1,
            pageRendering = false,
            pageNumPending = null,
