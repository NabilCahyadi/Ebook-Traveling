                            ...
                            <tr data-status="<?php echo e($ebook->status); ?>" style="height: 60px;">
                                ...
                                <td class="py-2">
                                    <?php if($ebook->status === 'published'): ?>
                                        <span class="badge bg-success" style="font-size: 0.75rem;"><?php echo e(__('admin.ebooks.published')); ?></span>
                                    <?php elseif($ebook->status === 'draft'): ?>
                                        <span class="badge bg-warning" style="font-size: 0.75rem;"><?php echo e(__('admin.ebooks.draft')); ?></span>
                                    <?php else: ?>
