                    ...
                    <div class="card-body">
                        <div class="d-flex justify-content-between align-items-start mb-3">
                            <div>
                                ...
                                <div class="text-muted mb-2">
                                    ...
                                    <?php endif; ?>
                                    <span class="mx-2">•</span>
                                    <i class="bx bx-show me-1"></i> <?php echo e(number_format($blog->view_count)); ?> views
                                </div>
                            </div>
                        ...
                        <?php if($blog->excerpt): ?>
                            <div class="alert alert-info">
                                <strong>Excerpt:</strong> <?php echo e($blog->excerpt); ?>
                ...
                <div class="card mb-4">
                    ...
                    <div class="card-body">
                        ...
                        <div class="mb-3">
                            ...
                            <p class="mb-0"><?php echo e($blog->author->name ?? 'Unknown'); ?></p>
                        </div>
                    ...
                    <div class="card-body">
                        ...
                        <div class="d-flex align-items-center mb-3">
                            ...
                            <div>
                                ...
                                <h6 class="mb-0"><?php echo e(number_format(strlen(strip_tags($blog->content)))); ?> characters</h6>
                            </div>
                        </div>
                        <div class="d-flex align-items-center">
                            ...
                            <div>
                                ...
                                <h6 class="mb-0"><?php echo e(ceil(str_word_count(strip_tags($blog->content)) / 200)); ?> min read
                                </h6>
                            </div>
                        </div>
                    </div>
