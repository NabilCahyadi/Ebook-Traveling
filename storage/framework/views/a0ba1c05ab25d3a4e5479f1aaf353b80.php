<?php $__env->startSection('title', 'View Ebook'); ?>
                ...
                <div>
                    ...
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb mb-0">
                            ...
                            <li class="breadcrumb-item"><a href="<?php echo e(route('admin.ebooks.index')); ?>">Ebooks</a></li>
    ...
    <div class="row">
                    ...
                    <div class="d-flex justify-content-between align-items-start flex-wrap gap-3">
                        <div>
                            ...
                            <p class="text-muted mb-0">
                                <i class="bx bx-user me-1"></i> <?php echo e($ebook->author ?? 'Unknown Author'); ?>
        ...
        <div class="col-lg-8">
                ...
                <div class="card-body">
                    <table class="table table-borderless">
                        ...
                        <tr>
                            ...
                            <td>
                                <i class="bx bx-file me-1"></i><?php echo e($ebook->page_count ?? '-'); ?> pages
                            </td>
                        </tr>
                        <tr>
            ...
            <div class="card mb-3">
                ...
                <div class="card-body">
                    <div class="mb-0">
                        <?php echo $ebook->description ?? '<p class="text-muted">No description available for this ebook.</p>'; ?>
