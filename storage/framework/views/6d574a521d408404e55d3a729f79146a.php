...
<div class="container-xxl flex-grow-1 container-p-y">
    <div class="d-flex justify-content-between align-items-center mb-4">
        <h4 class="fw-bold">Role Permissions Management</h4>
    </div>
        ...
        <div class="col-md-6 col-lg-4">
            <div class="card h-100">
                <div class="card-body">
                    ...
                    <p class="text-muted small mb-3"><?php echo e($role->description ?? 'No description'); ?></p>
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\PROJEK PROJEK\Ebook-Traveling\resources\views/admin/role-permissions/index.blade.php ENDPATH**/ ?>