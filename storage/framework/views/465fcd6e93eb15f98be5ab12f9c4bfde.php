<?php $__env->startSection('title', __('admin.role_permissions.title') . ' - ' . $role->name); ?>

<?php $__env->startSection('content'); ?>
<div class="container-xxl flex-grow-1 container-p-y">
    <div class="d-flex justify-content-between align-items-center mb-4">
        <div>
            <h4 class="fw-bold mb-1"><?php echo e(__('admin.role_permissions.title')); ?></h4>
            <p class="text-muted mb-0"><?php echo e(__('admin.role_permissions.managing_permissions')); ?> <strong><?php echo e($role->name); ?></strong> role</p>
            <?php if(isset($isGuestRole) && $isGuestRole): ?>
            <div class="alert alert-info mt-2 mb-0">
                <i class="ti ti-info-circle me-1"></i>
                <strong><?php echo e($role->name); ?> <?php echo e(__('admin.role_permissions.role_info')); ?></strong>
            </div>
            <?php endif; ?>
        </div>
        <a href="<?php echo e(route('admin.role-permissions.index')); ?>" class="btn btn-label-secondary">
            <i class="ti ti-arrow-left me-1"></i><?php echo e(__('admin.role_permissions.back_to_roles')); ?>
    ...
    <form action="<?php echo e(route('admin.role-permissions.update', $role->id)); ?>" method="POST">
        ...
        <div class="card mb-4">
            <div class="card-header d-flex justify-content-between align-items-center">
                <h5 class="mb-0">
                    <i class="ti ti-lock-access me-2"></i><?php echo e(__('admin.role_permissions.permission_modules')); ?>

                </h5>
                <span class="badge bg-primary" id="selectedCount">0 <?php echo e(__('admin.role_permissions.permissions_selected')); ?></span>
            </div>
            <div class="card-body">
                <div class="row g-4">
                        ...
                        <div class="card border shadow-none h-100">
                            <div class="card-header bg-label-primary d-flex justify-content-between align-items-center">
                                ...
                                <div class="form-check">
                                    ...
                                    <label class="form-check-label small"><?php echo e(__('admin.role_permissions.select_all')); ?></label>
                                </div>
                            </div>
