...
unset($__errorArgs, $__bag); ?>
                                            ...
                                            <div class="card-body">
                                                <div class="row">
                                                    ...
                                                    <div class="col-md-6 condition-value-wrapper"
                                                        style="<?php echo e($condition['condition_type'] === 'first_subscription' ? 'display:none;' : ''); ?>">
                                                        <label>Value <span class="value-required text-danger"
                                                                style="<?php echo e(in_array($condition['condition_type'], ['subscription_type', 'min_price', 'new_user']) ? '' : 'display:none;'); ?>">*</span></label>
                                                        <input type="number"
                                                            class="form-control condition-value condition-value-text"
                                                            name="conditions[<?php echo e($index); ?>][condition_value_text]"
                                                            value="<?php echo e(in_array($condition['condition_type'], ['min_price', 'new_user']) ? $condition['condition_value'] ?? '' : ''); ?>"
                                                            step="1" placeholder="Enter value"
                                                            style="<?php echo e(!in_array($condition['condition_type'], ['min_price', 'new_user']) ? 'display:none;' : ''); ?>">
                                                        
                                                        <div class="subscription-plan-selector" style="<?php echo e($condition['condition_type'] !== 'subscription_type' ? 'display:none;' : ''); ?>">
                                                            <select class="form-select condition-plan-selector">
                                                                ...
                                                                <?php $__currentLoopData = $subscriptionPlans; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $plan): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                                    <option value="<?php echo e($plan->name); ?>" data-price="<?php echo e(number_format($plan->price, 0, ',', '.')); ?>">
                                                            ...
                                                            <div class="selected-plans mt-2">
                                                                <?php if($condition['condition_type'] === 'subscription_type' && isset($condition['condition_value'])): ?>
                                                                    <?php $__currentLoopData = explode(',', $condition['condition_value']); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $planName): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                                        <span class="plan-badge"><?php echo e($planName); ?><span class="remove-plan">&times;</span></span>
                                                                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                                                <?php endif; ?>
                                                            </div>
            ...
            <div class="col-lg-4">
                <div class="card mb-4">
                    <div class="card-header">
                        <h5 class="mb-0">
                            <i class="ti ti-help"></i> <?php echo e(__('admin.promos.help_tips')); ?>

                        </h5>
                    </div>
                    <div class="card-body">
                        <h6 class="font-weight-bold"><?php echo e(__('admin.promos.help_discount_types')); ?>:</h6>
                        <ul class="small">
                            <li><strong><?php echo e(__('admin.promos.help_percentage')); ?>:</strong> <?php echo e(__('admin.promos.help_percentage_desc')); ?></li>
                            <li><strong><?php echo e(__('admin.promos.help_fixed_amount')); ?>:</strong> <?php echo e(__('admin.promos.help_fixed_amount_desc')); ?></li>
                            <li><strong><?php echo e(__('admin.promos.help_free_trial')); ?>:</strong> <?php echo e(__('admin.promos.help_free_trial_desc')); ?></li>
                        </ul>

                        <h6 class="font-weight-bold mt-3"><?php echo e(__('admin.promos.help_condition_types')); ?>:</h6>
                        <ul class="small">
                            <li><strong><?php echo e(__('admin.promos.help_new_user')); ?>:</strong> <?php echo e(__('admin.promos.help_new_user_desc')); ?></li>
                            <li><strong><?php echo e(__('admin.promos.help_first_subscription')); ?>:</strong> <?php echo e(__('admin.promos.help_first_subscription_desc')); ?></li>
                            <li><strong><?php echo e(__('admin.promos.help_subscription_type')); ?>:</strong> <?php echo e(__('admin.promos.help_subscription_type_desc')); ?></li>
                            <li><strong><?php echo e(__('admin.promos.help_min_price')); ?>:</strong> <?php echo e(__('admin.promos.help_min_price_desc')); ?></li>
                        </ul>

                        <h6 class="font-weight-bold mt-3"><?php echo e(__('admin.promos.help_examples')); ?>:</h6>
                        <div class="alert alert-info small">
                            <strong><?php echo e(__('admin.promos.help_example1_title')); ?>:</strong><br>
                            <?php echo e(__('admin.promos.help_example1_desc')); ?>

                        </div>
                        <div class="alert alert-success small">
                            <strong><?php echo e(__('admin.promos.help_example2_title')); ?>:</strong><br>
                            <?php echo e(__('admin.promos.help_example2_desc')); ?>
