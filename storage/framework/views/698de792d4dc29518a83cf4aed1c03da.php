<?php $__env->startSection('title', __('admin.activity_logs.title')); ?>
...
<?php $__env->startSection('content'); ?>
    <div class="container-fluid">
        ...
        <div class="d-flex justify-content-between align-items-center mb-4">
            <div>
                <h4 class="mb-1"><?php echo e(__('admin.activity_logs.title')); ?></h4>
                <p class="text-muted mb-0"><?php echo e(__('admin.activity_logs.description')); ?></p>
            </div>
            <div>
                <a href="<?php echo e(route('admin.user-activity-logs.export', request()->all())); ?>" class="btn btn-outline-primary">
                    <i class="ti ti-download me-1"></i> <?php echo e(__('admin.activity_logs.export_csv')); ?>
        ...
        <div class="card mb-4">
            <div class="card-body">
                <form method="GET" action="<?php echo e(route('admin.user-activity-logs.index')); ?>" class="row g-3">
                    <div class="col-md-3">
                        <label for="user_id" class="form-label"><?php echo e(__('admin.activity_logs.user')); ?></label>
                        <select name="user_id" id="user_id" class="form-select">
                            <option value=""><?php echo e(__('admin.activity_logs.all_users')); ?></option>
                    ...
                    <div class="col-md-2">
                        <label for="action" class="form-label"><?php echo e(__('admin.activity_logs.action')); ?></label>
                    ...
                    <div class="col-md-2">
                        <label for="date_from" class="form-label"><?php echo e(__('admin.activity_logs.date_from')); ?></label>
                        <input type="date" name="date_from" id="date_from" class="form-control"
                            value="<?php echo e(request('date_from')); ?>">
                    </div>

                    <div class="col-md-2">
                        <label for="date_to" class="form-label"><?php echo e(__('admin.activity_logs.date_to')); ?></label>
                        <input type="date" name="date_to" id="date_to" class="form-control"
                            value="<?php echo e(request('date_to')); ?>">
                    </div>

                    <div class="col-md-2">
                        <label for="search" class="form-label"><?php echo e(__('admin.activity_logs.search')); ?></label>
                        <input type="text" name="search" id="search" class="form-control" placeholder="<?php echo e(__('admin.activity_logs.search')); ?>..."
                ...
                <?php if($logs->count() > 0): ?>
                    <div class="table-responsive">
                        <table class="table table-hover">
                            <thead>
                                <tr>
                                    <th><?php echo e(__('admin.activity_logs.time')); ?></th>
                                    <th><?php echo e(__('admin.activity_logs.user')); ?></th>
                                    <th><?php echo e(__('admin.activity_logs.role')); ?></th>
                                    <th><?php echo e(__('admin.activity_logs.action')); ?></th>
                                    <th><?php echo e(__('admin.activity_logs.url')); ?></th>
                                    <th><?php echo e(__('admin.activity_logs.model')); ?></th>
                                    <th>IP Address</th>
