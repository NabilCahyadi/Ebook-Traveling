    ...
    <div class="container">
            ...
            <div>
                <div class="style-4">
                    <div class="rectangle single-animation-wrap rounded mt-15" style="position: relative;">
                        <?php if($bannerData): ?>
                            <img src="<?php echo e(asset('storage/' . $bannerData->image)); ?>" alt="Banner"
        ...
        <section id="pricing-plans" class="benefits-section py-5">
            <div class="container text-center">
                ...
                <p
                    style="max-width: 50rem; margin: 0.5rem auto 0; text-align: center; color: #6b7280; margin-bottom: 3rem;">
                    Choose the best plan to power your projects, from small personal websites to large-scale enterprise
                    applications.
                </p>
                ...
                <?php if(isset($groupedSubscriptionPlans) && $groupedSubscriptionPlans->isNotEmpty()): ?>
                    ...
                    <ul class="nav nav-pills justify-content-center mb-5" id="pricingTab" role="tablist">
                        <?php $__currentLoopData = $groupedSubscriptionPlans; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $categoryKey => $plans): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <li class="nav-item" role="presentation">
                                <button class="nav-link <?php echo e($loop->first ? 'active' : ''); ?>" id="<?php echo e($categoryKey); ?>-tab"
                                    data-bs-toggle="pill" data-bs-target="#<?php echo e($categoryKey); ?>" type="button"
                                    role="tab" aria-controls="<?php echo e($categoryKey); ?>"
                    ...
                    <div class="tab-content" id="pricingTabContent">
                        <?php $__currentLoopData = $groupedSubscriptionPlans; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $categoryKey => $plans): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <div class="tab-pane fade <?php echo e($loop->first ? 'show active' : ''); ?>" id="<?php echo e($categoryKey); ?>"
                                role="tabpanel" aria-labelledby="<?php echo e($categoryKey); ?>-tab">
                                    ...
                                    <?php $__currentLoopData = $plans; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $plan): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            ...
                                            <div class="pricing-button-container">
                                                <?php if($user): ?>
                                                    <?php
                                                        ...
                                                        $isCurrentPlan =
                                                            $isActive &&
                                                            $currentSub->subscription_plan_id === $plan->id;
                                                        $currentPlan = $user->currentPlan ?? null;
                                                        $currentDuration = $currentPlan
                                                    ...
                                                    <?php if($isActive): ?>
                                                        <?php if($isCurrentPlan): ?>
                                                            ...
                                                            <form action="<?php echo e(route('subscription.renew')); ?>" method="POST"
                                                                ...
                                                                <button type="submit"
                                                                    class="btn text-white pricing-button--primary rounded-pill py-3 w-100 mb-1">
                                                                    Renew Subscription
                                                                </button>
                                                            </form>
                                                        <?php elseif($plan->duration_days > $currentDuration): ?>
                                                        ...
                                                        <?php endif; ?>
                                                    <?php else: ?>
                                                        <?php if(str_contains($plan->mayar_payment_link, 'mayar.shop')): ?>
                                                            
                                                            <a href="<?php echo e($plan->mayar_payment_link); ?>"
                                                        ...
                                                        <?php else: ?>
                                                            ...
                                                            <a href="<?php echo e(route('subscribe.redirect', $plan->slug)); ?>"
                                                                class="btn text-white pricing-button--primary rounded-pill py-3 w-100 mb-1 text-center"
                                                    ...
                                                    <?php
                                                        ...
                                                        $whatsappInfo = \App\Models\ContactInfo::where(
                                                            'contact_type',
                                                            'whatsapp',
                                                        )->first();
                                                        ...
                                                        // Format teks pesan
                                                        $waText = urlencode(
                                                            "Halo Admin, saya ingin berlangganan.\n\nNama\t: " .
                                                                $user->name .
                                                                "\nEmail\t: " .
                                                                $user->email .
                                                                "\nPaket\t: " .
                                                ...
                                                <?php else: ?>
                                                    ...
                                                    <a href="<?php echo e(route('login')); ?>"
                                                        class="btn text-white pricing-button--primary rounded-pill py-3 w-100 mb-1 text-white">
                                                        Login to Subscribe
                                                    </a>
                                                <?php endif; ?>
                                            </div>
                                        ...
                                        <?php if($user): ?>
                                            ...
                                            <?php if($user->currentSubscription && $user->currentSubscription->subscription_plan_id === $plan->id): ?>
                                                <div class="modal fade" id="renewModal-<?php echo e($plan->id); ?>" tabindex="-1"
                                                    data-bs-focus="false">
                                                    <div class="modal-dialog modal-dialog-centered">
                                                        <div class="modal-content border-0 shadow-lg">
                                                            <div class="modal-header bg-gradient-success text-white p-4">
                                                                <div>
                                                                    <h5 class="modal-title fw-bold">
                                                                        <i class="fi fi-rs-refresh me-2"></i> Renew
                                                                        <?php echo e($plan->name); ?>

                                                                    </h5>
                                                                    <small class="opacity-75">+<?php echo e($plan->duration_days); ?>
                                                            ...
                                                            <div class="modal-body p-4">
                                                                <div
                                                                    class="alert alert-light border-0 bg-light-subtle mb-4">
                                                                    <div class="d-flex align-items-center">
                                                                        <div class="bg-success bg-opacity-10 p-2 rounded">
                                                                            <i
                                                                                class="fi fi-rs-calendar-check text-success fs-4"></i>
                                                                        </div>
                                                                        <div class="ms-3">
                                                                            <div class="fw-bold">Current Expiry</div>
                                                                            <div>
                                                                                <?php echo e($user->currentSubscription->end_date->format('d M Y')); ?>
                                                                ...
                                                                <div
                                                                    ...
                                                                    <div class="text-end">
                                                                        <div class="text-success fw-bold">
                                                                            +<?php echo e($plan->duration_days); ?> days</div>
                                                                    </div>
                                                                </div>
                                                            ...
                                                            <div class="modal-footer bg-light p-3">
                                                                <form action="<?php echo e(route('api.subscription.create')); ?>"
                                                                    method="POST" class="w-100">
                                                                    <?php echo csrf_field(); ?>
                                            ...
                                            <?php if($user->currentPlan && $plan->price > $user->currentPlan->price): ?>
                                                <div class="modal fade" id="upgradeModal-<?php echo e($plan->id); ?>"
                                                        ...
                                                        <div class="modal-content border-0 shadow-sm"
                                                            ...
                                                            <div class="modal-header border-0 pb-0">
                                                                <div class="flex-grow-1 mt-4">
                                                                    <h4 class="modal-title fw-bold mb-1">Upgrade to
                                                                        <?php echo e($plan->name); ?></h4>
                                                                    <p class="mb-0">Get more access with enhanced
                                                                        features</p>
                                                                </div>
                                                            ...
                                                            <div class="modal-body px-4 pt-3 pb-4">
                                                                <!-- Plan Comparison -->
                                                                <div
                                                                    class="d-flex align-items-center justify-content-between mb-4 p-3 bg-light rounded-3">
                                                                    <div class="text-center flex-grow-1">
                                                                        <div class="text-muted small fw-medium mb-1">
                                                                            CURRENT PLAN</div>
                                                                        <h6 class="mb-1 fw-semibold">
                                                                            <?php echo e($user->currentPlan->name); ?></h6>
                                                                        <div class="text-dark fw-bold">
                                                                            Rp
                                                                            <?php echo e(number_format($user->currentPlan->price, 0, ',', '.')); ?>
                                                                    ...
                                                                    <div class="text-center flex-grow-1">
                                                                        <div class="text-primary small fw-medium mb-1">NEW
                                                                            PLAN</div>
                                                                        ...
                                                                        <ul class="list-unstyled mb-0">
                                                                            <?php $__currentLoopData = $plan->features; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $feature): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                                                <li class="mb-2 d-flex align-items-center">
                                                                                    <i
                                                                                        class="fi fi-rs-check-circle text-success me-2 fs-6"></i>
                                                                ...
                                                                <div class="bg-light rounded-3 p-3">
                                                                    <div
                                                                        ...
                                                                        <span class="fw-bold text-success fs-5">+Rp
                                                                            <?php echo e(number_format($diff, 0, ',', '.')); ?></span>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                                ...
                                                                <div class="d-grid gap-2 w-100">
                                                                    <form action="<?php echo e(route('api.subscription.create')); ?>"
                                                                        ...
                                                                        <button type="submit"
                                                                            ...
                                                                            <i class="fi fi-rs-arrow-up me-2"></i> Upgrade
                                                                            Now
                                                                        </button>
                                                                    </form>
                                                                </div>
        ...
        <section class="faqs-section py-5">
            <div class="container">
                ...
                <p class="text-center text-muted mb-4" style="max-width:54rem;margin:0 auto;">Common questions about
                    subscriptions, billing, and accessing your guides. If you need further help, contact our support team.
                </p>
                    ...
                    <?php if($faqs && $faqs->isNotEmpty()): ?>
                        <?php $__currentLoopData = $faqs; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $faq): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <div class="accordion-item rounded shadow-sm mb-3 p-0">
                                <div class="accordion-header d-flex justify-content-between align-items-center px-3 py-3"
                                    style="cursor:pointer;" onclick="toggleAccordion(this)">
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div class="position-relative newsletter-inner"
                            style="background-image: url('<?php echo e(asset($ctaBackground)); ?>'); background-size: cover; background-position: center; color: #ffffff; padding: 5rem 5rem 5rem 5rem; text-align: left; border-radius: 1rem;">
                            <div class="newsletter-content">
                                <h3 class="mb-20">
                                    Still confused about which subscription<br />
                                    package is right for you ?
                                </h3>
                                <p class="mb-45">Let's chat with the Gramedia team to ask for more information about the
                ...
                if (accordionMaxHeight == "0px" || accordionMaxHeight.length == 0) {
                    ...
                    document.querySelectorAll(".accordion-content").forEach(content => {
                        if (content !== accordionContent) {
                            ...
                            content.parentElement.querySelector(".fas").classList.remove(
                                "fa-minus");
