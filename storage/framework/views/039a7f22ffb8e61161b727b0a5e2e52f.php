        ...
        <div class="container">
            <div class="home-slide-cover mt-30">
                <div class="hero-slider-1 style-4 dot-style-1 dot-style-1-position-1 temp-hidden">
                    ...
                    ?>
                    <div class="single-hero-slider single-animation-wrap" style="background-image: url(<?php echo e(asset($imagePath)); ?>)">
        ...
        <div class="container">
            <div class="row">
                <div class="section-title style-2 section-title style-2 d-flex justify-content-between align-items-center">
                    ...
                    <a href="<?php echo e(route('pricing')); ?>#pricing-plans" class="show-all d-block d-md-none text-end" style="font-size: 0.70rem !important; margin-top:5px;">View All</a>
                    <a href="<?php echo e(route('pricing')); ?>#pricing-plans" class="show-all d-none d-md-inline text-end">View All</a>
                </div>
                ...
                <div class="<?php echo e($colClass); ?>">
                    <div class="banner-img wow animate__animated animate__fadeInUp" data-wow-delay="<?php echo e($delay); ?>s">
                        <a href="<?php echo e(route('pricing')); ?>#pricing-plans">
                            ...
                            <img src="<?php echo e(Storage::url($plan->cover_image)); ?>" alt="<?php echo e($plan->name); ?>">
                            <?php else: ?>
                            <img src="<?php echo e(asset('/images/banner-subs-1.webp')); ?>" alt="<?php echo e($plan->name); ?>">
                            <?php endif; ?>
                        </a>
                    </div>
                </div>
    ...
    <section class="product-tabs section-padding position-relative" style="margin-top: -50px">
        <div class="container">
            ...
            <div class="section-title style-2 wow animate__animated animate__fadeIn section-title style-2 d-flex justify-content-between align-items-center">
                <h3 class="d-block d-md-none" style="font-size: 0.80rem !important; line-height: 1.2 !important; margin-top:5px;"><?php echo e($collection->name); ?></h3>
                <h3 class="d-none d-md-block" style="font-size: 1.5rem !important; line-height: 1.3 !important;"><?php echo e($collection->name); ?></h3>
                <a href="/collections/<?php echo e($collection->slug); ?>" class="show-all d-block d-md-none text-end" style="font-size: 0.70rem !important; margin-top:5px;">View All</a>
                <a href="/collections/<?php echo e($collection->slug); ?>" class="show-all d-none d-md-inline text-end">View All</a>
            </div>
                                    ...
                                    <div class="product-content-wrap">
                                        ...
                                        <div class="product-meta">
                                            ...
                                            <div class="read-count">
                                                <i class="fi fi-rs-eye align-middle"></i><!--  <?php echo e(number_format($ebook->view_count)); ?> -->
                                                <span class="post-on">
                                                    <?php
                                        ...
                                        $isSingleLine = strlen($descriptionText) <= 29;
                                            ...
                                            <?php else: ?>
                                            <a href="<?php echo e(route('pricing')); ?>#pricing-plans" class="action-btn btn-subscribe-now">
    ...
    <section class="section-padding pb-5" style="margin-top: -50px">
        <div class="container mb-30">
            <div class="section-title style-2 section-title style-2 d-flex justify-content-between align-items-center">
                ...
                <a href="<?php echo e(route('blogs.index')); ?>" class="show-all d-block d-md-none text-end" style="font-size: 0.70rem !important; margin-top:5px;">View All</a>
                <a href="<?php echo e(route('blogs.index')); ?>" class="show-all d-none d-md-inline text-end">View All</a>
            </div>
            <div class="loop-grid">
                <div class="row">
                    ...
                    <article class="col-xl-3 col-lg-4 col-md-6 text-center hover-up mb-30 animated">
                        <div class="post-thumb">
                            <a href="<?php echo e(route('blogs.show', $blog->slug)); ?>">
                                <img class="border-radius-15" src="<?php echo e($blog->featured_image_url); ?>" alt="<?php echo e($blog->title); ?>" />
                            </a>
                        </div>
