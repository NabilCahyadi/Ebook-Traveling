...
unset($__errorArgs, $__bag); ?>" id="duration_days"
                                name="duration_days" required>
                                <option value="">Select Duration</option>
                                <option value="30" <?php echo e(old('duration_days') == 30 ? 'selected' : ''); ?>>1 Month (30
                                    Days)
                                </option>
                                <option value="180" <?php echo e(old('duration_days') == 180 ? 'selected' : ''); ?>>6 Months (180
                                    Days)</option>
                                <option value="365" <?php echo e(old('duration_days') == 365 ? 'selected' : ''); ?>>1 Year (365
                                    Days)</option>
