...
unset($__errorArgs, $__bag); ?>" 
                                          ...
                                          placeholder="Brief description of this collection..."><?php echo e(old('description')); ?></textarea>
                            ...
                            <div class="mb-3">
                                ...
                                <div class="form-check form-switch mb-2">
                                    <input class="form-check-input" type="checkbox" id="show_in_homepage" 
                                           name="show_in_homepage" value="1" <?php echo e(old('show_in_homepage') ? 'checked' : ''); ?>>
                                ...
                                <div class="form-check form-switch">
                                    <input class="form-check-input" type="checkbox" id="is_visible_on_landing" 
                                           name="is_visible_on_landing" value="1" <?php echo e(old('is_visible_on_landing') ? 'checked' : ''); ?>>
