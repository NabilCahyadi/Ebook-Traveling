                        ...
                        <div class="dropdown">
                            ...
                            <div class="dropdown-menu dropdown-menu-end">
                                <?php if(Route::has('admin.orders.index')): ?>
                                    <a class="dropdown-item" href="<?php echo e(route('admin.orders.index')); ?>"><?php echo e(__('admin.dashboard.view_orders')); ?></a>
                                <?php endif; ?>
                            </div>
                        </div>
                    </div>
                ...
                <div class="card-body">
                    <div class="d-flex justify-content-between align-items-start">
                        ...
                        <div class="dropdown">
                            ...
                            <div class="dropdown-menu dropdown-menu-end">
                                <?php if(Route::has('admin.orders.index')): ?>
                                    <a class="dropdown-item" href="<?php echo e(route('admin.orders.index')); ?>"><?php echo e(__('admin.dashboard.view_all_orders')); ?></a>
                                <?php endif; ?>
                            </div>
                        </div>
                    </div>
        ...
        <div class="col-xl-6 col-12">
            <div class="card h-100">
                <div class="card-header d-flex justify-content-between align-items-center">
                    ...
                    <a href="<?php echo e(route('admin.ebooks.index')); ?>" class="btn btn-sm btn-outline-primary">View All</a>
                </div>
                <div class="card-body">
                    <div class="row g-3">
                        <div class="col-6 col-md-4">
                            <div class="d-flex align-items-center p-3 rounded bg-label-warning">
                                ...
                                <div>
                                    <h5 class="mb-0"><?php echo e($ebookStatusCounts['draft'] ?? 0); ?></h5>
                                    <small>Draft</small>
                                </div>
                            </div>
                        </div>
                        <div class="col-6 col-md-4">
                            <div class="d-flex align-items-center p-3 rounded bg-label-success">
                                ...
                                <div>
                                    <h5 class="mb-0"><?php echo e($ebookStatusCounts['published'] ?? 0); ?></h5>
                        ...
                        <div class="col-6 col-md-4">
                            <div class="d-flex align-items-center p-3 rounded bg-label-info">
                                ...
                                <div>
                                    <h5 class="mb-0"><?php echo e($ebookStatusCounts['scheduled'] ?? 0); ?></h5>
                        ...
                        <div class="col-6 col-md-4">
                            <div class="d-flex align-items-center p-3 rounded bg-label-secondary">
                                ...
                                <div>
                                    <h5 class="mb-0"><?php echo e($ebookStatusCounts['unpublished'] ?? 0); ?></h5>
                        ...
                        <div class="col-6 col-md-4">
                            <div class="d-flex align-items-center p-3 rounded bg-label-danger">
                                ...
                                <div>
                                    <h5 class="mb-0"><?php echo e($ebookStatusCounts['trash'] ?? 0); ?></h5>
                                    <small>Trash</small>
                                </div>
                            </div>
                        </div>
                        <div class="col-6 col-md-4">
                            <div class="d-flex align-items-center p-3 rounded bg-label-primary">
                                ...
                                <div>
                                    <h5 class="mb-0"><?php echo e($totalEbooks); ?></h5>
                                    <small>Total</small>
                                </div>
                            </div>
                        </div>
        ...
        <div class="col-xl-6 col-12">
            <div class="card h-100">
                <div class="card-header d-flex justify-content-between align-items-center">
                    ...
                    <a href="<?php echo e(route('admin.blogs.index')); ?>" class="btn btn-sm btn-outline-primary">View All</a>
                </div>
                <div class="card-body">
                    <div class="row g-3">
                        <div class="col-6 col-md-4">
                            <div class="d-flex align-items-center p-3 rounded bg-label-warning">
                                ...
                                <div>
                                    <h5 class="mb-0"><?php echo e($blogStatusCounts['draft'] ?? 0); ?></h5>
                                    <small>Draft</small>
                                </div>
                            </div>
                        </div>
                        <div class="col-6 col-md-4">
                            <div class="d-flex align-items-center p-3 rounded bg-label-success">
                                ...
                                <div>
                                    <h5 class="mb-0"><?php echo e($blogStatusCounts['published'] ?? 0); ?></h5>
                                    <small>Published</small>
                                </div>
                            </div>
                        </div>
                        <div class="col-6 col-md-4">
                            <div class="d-flex align-items-center p-3 rounded bg-label-info">
                                ...
                                <div>
                                    <h5 class="mb-0"><?php echo e($blogStatusCounts['scheduled'] ?? 0); ?></h5>
                                    <small>Scheduled</small>
                                </div>
                            </div>
                        </div>
                        <div class="col-6 col-md-4">
                            <div class="d-flex align-items-center p-3 rounded bg-label-secondary">
                                ...
                                <div>
                                    <h5 class="mb-0"><?php echo e($blogStatusCounts['unpublished'] ?? 0); ?></h5>
                                    <small>Unpublished</small>
                                </div>
                            </div>
                        </div>
                        <div class="col-6 col-md-4">
                            <div class="d-flex align-items-center p-3 rounded bg-label-danger">
                                ...
                                <div>
                                    <h5 class="mb-0"><?php echo e($blogStatusCounts['trash'] ?? 0); ?></h5>
                                    <small>Trash</small>
                                </div>
                            </div>
                        </div>
                        <div class="col-6 col-md-4">
                            <div class="d-flex align-items-center p-3 rounded bg-label-primary">
                                ...
                                <div>
                                    ...
                                    ?>
                                    <h5 class="mb-0"><?php echo e($totalBlogs); ?></h5>
                                    <small>Total</small>
                                </div>
                            </div>
                        </div>
                                    ...
                                    <?php $__currentLoopData = $recentEbooks; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $ebook): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <?php else: ?>
                                                    <span class="badge bg-label-secondary"><?php echo e(ucfirst($ebook->status)); ?></span>
                                                <?php endif; ?>
                                            </td>
                                            <td>
                                                <small
