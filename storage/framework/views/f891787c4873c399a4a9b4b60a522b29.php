    ...
    <div class="row g-4 mb-4">
        ...
        <div class="col-xl-6 col-12">
            <div class="card h-100">
                <div class="card-header">
                    <div>
                        <h5 class="card-title mb-1"><?php echo e(__('admin.dashboard.revenue_overview')); ?></h5>
                        <p class="card-subtitle mb-0"><?php echo e(__('admin.dashboard.monthly_revenue_subtitle')); ?></p>
                    </div>
                </div>
                <div class="card-body">
