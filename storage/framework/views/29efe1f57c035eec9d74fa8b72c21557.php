...
<div class="auth-centered-container">
    <div class="auth-centered-form">
        <form method="POST" action="<?php echo e(route('password.send-code')); ?>">
            <?php echo csrf_field(); ?>
            <!-- Logo di atas teks -->
            <img src="<?php echo e(asset('images/logo_horizontall.png')); ?>" alt="Logo" class="auth-logo">
...
<?php echo $__env->make('layouts.auth', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\ebook_traveling\resources\views\auth\forgot-password.blade.php ENDPATH**/ ?>