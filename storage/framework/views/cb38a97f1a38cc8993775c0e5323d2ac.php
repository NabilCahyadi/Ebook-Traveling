                            ...
                            <ul class="nav flex-column" role="tablist">
                                ...
                                <li class="nav-item">
                                    <a class="nav-link d-flex align-items-center px-3 py-2 <?php echo e(request('tab') == 'wishlist' ? 'active bg-light-subtle' : 'text-body'); ?>"
                                        ...
                                        <i
                                            class="fi fi-rs-heart me-3 fs-5 mt-1 <?php echo e(request('tab') == 'wishlist' ? 'text-white' : 'text-danger'); ?>"></i>
                                        <span>Wishlist</span>
    ...
    <?php endif; ?> -->
                    ...
                    <div class="col-md-9">
                        <div class="tab-content account dashboard-content pl-50">
                            ...
                            <div class="tab-pane fade <?php echo e(request('tab', 'dashboard') == 'dashboard' ? 'active show' : ''); ?>"
                                ...
                                <div class="card">
                                    ...
                                    <div class="card-header border-0 pb-3">
                                        <h4 class="mb-1">Hello <?php echo e(auth()->user()->name); ?>!</h4>
                                        <small class="text-muted">
                                            <?php if(auth()->user()->hasActiveSubscription()): ?>
                                                Premium Member since <?php echo e(auth()->user()->created_at->format('M Y')); ?>
                                    ...
                                    <div class="card-body p-4">
                                        ...
                                        <?php else: ?>
                                            ...
                                            <div class="alert alert-light border border-info-subtle rounded-3 mb-0 p-3">
                                                ...
                                                <a href="<?php echo e(route('pricing')); ?>#pricing-plans" class="btn btn-sm btn-outline-info">View
                                                    Plans</a>
                                            </div>
                                        <?php endif; ?>
                            ...
                            <!-- WISHLIST TAB -->
                            <div class="tab-pane fade <?php echo e(request('tab') == 'wishlist' ? 'active show' : ''); ?>"
                                                    ...
                                                    <tbody>
                                                        <?php $__currentLoopData = $wishlistItems; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $ebook): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                            <tr>
                                                                ...
                                                                <td>
                                                                    <div class="fw-bold">
                                                                        <?php echo e($ebook->title ?? 'Unknown Book'); ?></div>
                                                                    <?php if($ebook->creator): ?>
                                                                        <small class="text-muted">by
                                                                            <?php echo e($ebook->creator->name); ?></small>
                                                                    <?php endif; ?>
                                                                </td>
                                                                ...
                                                                <td>
                                                                    <?php if($ebook->categories && $ebook->categories->count() > 0): ?>
                                                                        <?php $__currentLoopData = $ebook->categories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $category): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                                            <span
                                                                                class="badge bg-light text-dark border me-1"><?php echo e($category->name); ?></span>
                            ...
                            <div class="tab-pane fade <?php echo e(request('tab') == 'account-detail' ? 'active show' : ''); ?>"
                                ...
                                <div class="card mb-4">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <form method="POST" action="<?php echo e(route('account.update.avatar')); ?>"
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="form-group col-md-6">
                                                    ...
                                                    <textarea class="form-control" name="bio" rows="4" placeholder="Tell us about yourself..."
                                                        style="min-height: 150px; resize: vertical;"><?php echo e(old('bio', auth()->user()->profile->bio ?? '')); ?></textarea>
                            ...
                            <div class="tab-pane fade <?php echo e(request('tab') == 'subscription' ? 'active show' : ''); ?>"
                                ...
                                <div class="card border-0 shadow-sm">
                                    <div
                                        ...
                                        ?>
                                        <span class="badge <?php echo e($headerBadgeClass); ?> rounded-pill px-3 py-2">
                                            <?php echo e($headerBadge); ?>
                                    ...
                                    <div class="card-body">
                                        <?php if($user->hasActiveSubscription()): ?>
                                            ...
                                            <div class="row mb-4">
                                                ...
                                                <div class="col-md-6">
                                                    ...
                                                    <div class="mb-3">
                                                        ...
                                                        <?php if($paymentType === 'renewal'): ?>
                                                            <p class="mb-0">
                                                                <span class="badge bg-info-subtle text-danger mb-1"
                                                                    style="border:1px solid #FF416C; border-radius: 100px; ">
                                                                    Renewed
                                                                </span><br>
                                                                Extended by <strong><?php echo e($durationDays); ?>

                                                                    day<?php echo e($durationDays > 1 ? 's' : ''); ?></strong><br>
                                                                <small class="text-muted">
                                                                    <?php echo e($sub->start_date->format('d M Y H:i')); ?> –
                                                                    <?php echo e($sub->end_date->format('d M Y H:i')); ?>

                                                                </small>
                                                            </p>
                                                        <?php elseif($paymentType === 'upgrade'): ?>
                                                            <p class="mb-0">
                                                                <span class="badge bg-primary-subtle text-primary mb-1">
                                                                    <i class="fi fi-rs-arrow-up me-1"></i> Upgraded
                                                                </span><br>
                                                                Upgraded on
                                                                <strong><?php echo e($sub->start_date->format('d M Y H:i')); ?></strong><br>
                                                                <small class="text-muted">
                                                                    Valid until <?php echo e($sub->end_date->format('d M Y H:i')); ?>
                                                        ...
                                                        <?php else: ?>
                                                            <p class="mb-0">
                                                                ...
                                                                <strong><?php echo e($durationDays); ?>

                                                                    day<?php echo e($durationDays > 1 ? 's' : ''); ?></strong>
                                                                access<br>
                                                                <small class="text-muted">
                                                                    <?php echo e($sub->start_date->format('d M Y H:i')); ?> –
                                                                    <?php echo e($sub->end_date->format('d M Y H:i')); ?>
                                                ...
                                                <div class="col-md-6">
                                                    ...
                                                    <div class="mb-3">
                                                        ...
                                                        <p class="h5 mb-0 text-danger">Rp
                                                            <?php echo e(number_format($sub->total_amount, 0, ',', '.')); ?></p>
                                                    </div>
                                                    <?php
                                            ...
                                            <!-- Upgrade Options -->
                                            <?php if(isset($subscriptionPlans) && $subscriptionPlans->isNotEmpty()): ?>
                                                <div class="mt-4 pt-3 border-top">
                                                    <h6 class="fw-bold mb-3">Upgrade to Higher Tier</h6>
                                                    <div class="row g-3">
                                                        <?php $__currentLoopData = $subscriptionPlans; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $upgradePlan): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                            <div class="col-lg-4 col-md-6">
                                                                <div class="card border-primary h-100">
                                                                    <div class="card-body d-flex flex-column">
                                                                        <h6 class="card-title mb-2">
                                                                            <?php echo e($upgradePlan->name); ?></h6>
                                                                        <p class="text-muted small mb-2">
                                                                            <i class="bi bi-calendar-check me-1"></i>
                                                                            <?php echo e($upgradePlan->duration_days); ?> days access
                                                                        </p>
                                                                        <p class="h5 text-success mb-3">Rp
                                                                            <?php echo e(number_format($upgradePlan->price, 0, ',', '.')); ?>

                                                                        </p>
                                                                        <form action="<?php echo e(route('subscription.upgrade')); ?>"
                                                                            method="POST" class="mt-auto">
                                                                            <?php echo csrf_field(); ?>
                                                                            <input type="hidden" name="plan_slug"
                                                                                value="<?php echo e($upgradePlan->slug); ?>">
                                                                            <button type="submit"
                                                ...
                                                <table class="table table-hover align-middle">
                                                    ...
                                                    <tbody class="px-3">
                                                        <?php $__currentLoopData = $user->payments()->with(['plan', 'subscription'])->latest()->get(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $payment): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                            ...
                                                            <tr>
                                                                <td class="ps-3 py-3">
                                                                    <?php echo e($payment->created_at->format('d M Y')); ?></td>
                                                                    ...
                                                                    <?php if($sub): ?>
                                                                        <?php if($paymentType === 'renewal'): ?>
                                                                            ...
                                                                            <div class="small">
                                                                                Extended
                                                                                <strong
                                                                                    class="text-success">+<?php echo e($durationDays); ?>

                                                                                    day<?php echo e($durationDays > 1 ? 's' : ''); ?>
                                                                        ...
                                                                        <?php else: ?>
                                                                            ...
                                                                            <div class="small">
                                                                                ...
                                                                                <strong><?php echo e($sub->end_date->format('d M Y H:i')); ?></strong>
                                                                            </div>
                                                                        <?php endif; ?>
                                                                    <?php else: ?>
                                                                ...
                                                                <td class="py-3 fw-medium">Rp
                                                                    <?php echo e(number_format((float) $payment->amount, 0, ',', '.')); ?>

                                                                </td>
                                                                <td class="py-3">
                                                                    <?php echo e(ucfirst($payment->payment_method ?? '—')); ?></td>
                                                                <td class="py-3 text-center">
                                                                    ...
                                                                    <div
                                                                        ...
                                                                        <?php if($sub): ?>
                                                                            <span
                                                                                class="badge <?php echo e($statusBadgeClass); ?> rounded-pill px-2 py-1">
                            ...
                            <div class="tab-pane fade <?php echo e(request('tab') == 'payment' ? 'active show' : ''); ?>"
                                                                    ...
                                                                    <div>
                                                                        <div class="d-flex align-items-center mb-2">
                                                                            ...
                                                                            <h6 class="mb-0 fw-bold">
                                                                                <?php echo e($subscription->plan->name ?? 'Basic Plan'); ?>
                                                                    ...
                                                                    <div>
                                                                        <div class="d-flex align-items-center mb-2">
                                                                            ...
                                                                            <h6 class="mb-0 fw-bold">Order
                                                                                #<?php echo e($order->order_code ?? $order->id); ?>
                                                                        ...
                                                                        <?php $__currentLoopData = $order->items; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                                            <div class="col-md-6">
                                                                                <div class="d-flex align-items-center">
                                                                                    ...
                                                                                    <div class="ms-2">
                                                                                        <div class="fw-medium">
                                                                                            <?php echo e(Str::limit($item->ebook->title, 25)); ?>

                                                                                        </div>
                                                                                        <small
                                                                                            class="text-muted">x<?php echo e($item->quantity); ?></small>
                                                                                    </div>
                                                                                </div>
                                                                            </div>
                                                                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                            ...
                            <!-- MY LIBRARY TAB -->
                            <div class="tab-pane fade <?php echo e(request('tab') == 'library' ? 'active show' : ''); ?>"
                                                    ...
                                                    <select name="city_slug" id="city_slug"
                                                        ...
                                                        <?php $__currentLoopData = $cities; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $city): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                            <option value="<?php echo e($city->slug); ?>"
                                                                <?php echo e(request('city_slug') == $city->slug ? 'selected' : ''); ?>>
                                                ...
                                                <?php $__currentLoopData = $allEbooks; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $ebook): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                    <div class="col-lg-3 col-md-4 col-sm-6 mb-4">
                                                        <div class="product-cart-wrap mb-30 wow animate__animated animate__fadeIn"
                                                            data-wow-delay="<?php echo e(($index % 4) * 0.1); ?>s">
                                                            <div class="product-img-action-wrap">
                                                                ...
                                                                <div
                                                                    ...
                                                                    <span
                                                                        class="badge-language hot"><?php echo e(strtoupper($ebook->language ?? 'ID')); ?></span>
                                                                </div>
                                                            </div>
                                                            <div class="product-content-wrap">
                                                                    ...
                                                                    <div class="product-detail-rating">
                                                                        <div class="product-rate-cover text-end">
                                                                            <div class="product-rate-cover">
                                                                                ...
                                                                                <span
                                                                                    class="font-small ml-5 text-muted">(<?php echo e(round($ebook->ratings()->avg('rating') ?? 0, 1)); ?>)</span>
                                                                            </div>
                                                                        </div>
                                                                    </div>
                                                                ...
                                                                ?>
                                                                <p
                                                                    class="product-description <?php echo e($isSingleLine ? 'single-line' : ''); ?>">
                                                                ...
                                                                <?php if($progress > 0): ?>
                                                                    ...
                                                                    <small
                                                                        class="text-success"><?php echo e(number_format($progress, 0)); ?>%
                                                                        Complete</small>
                                                                <?php endif; ?>
                                                ...
                                                <div class="text-center py-5">
                                                    ...
                                                    <p class="text-muted">
                                                        ...
                                                        <?php if(request()->filled('search')): ?>
                                                            ...
                                                            "<strong><?php echo e(request('search')); ?></strong>" with different
                                                            keywords.
                                                        <?php endif; ?>
                                                    </p>
                                                    <a href="<?php echo e(route('page-account', ['tab' => 'library'])); ?>"
                                                    ...
                                                    <tbody>
                                                        <?php $__currentLoopData = $readingHistory; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $reading): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td><?php echo e($reading->last_read_at?->format('d M Y H:i') ?? '-'); ?>
                                                                    ...
                                                                    <div class="d-flex align-items-center">
                                                                        <div class="progress"
                                                                            ...
                                                                            <div class="progress-bar"
                                                                                style="width:<?php echo e($progress); ?>%; background-color: #FF4C61;">
                                                                            </div>
                                                                        </div>
                                                                        <small
                                                                            class="ms-2"><?php echo e(number_format($progress, 0)); ?>%</small>
                                                                    </div>
                                                                </td>
                            ...
                            <!-- MY REVIEWS TAB -->
                            <div class="tab-pane fade <?php echo e(request('tab') == 'reviews' ? 'active show' : ''); ?>"
                                            ...
                                            <div class="row g-4">
                                                <?php $__currentLoopData = $userRatings; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $rating): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                    <div class="col-12">
                                                                    ...
                                                                    <div class="card-body">
                                                                        <div
                                                                            ...
                                                                            <div class="d-flex align-items-center gap-2">
                                                                                ...
                                                                                <div class="rating">
                                                                                    <?php for($i = 1; $i <= 5; $i++): ?>
                                                                                        <i class="fi fi-rs-star<?php echo e($i <= $rating->rating ? ' text-danger' : ' text-muted'); ?>"
                                                                        ...
                                                                        <?php if($rating->review_title): ?>
                                                                            <h6 class="text-dark mb-2">
                                                                                <?php echo e($rating->review_title); ?></h6>
                                                                        <?php endif; ?>

                                                                        <p class="card-text mb-3">
                                                                            <?php echo e(Str::limit($rating->review_text, 200)); ?>
                                                                            ...
                                                                            <small>
                                                                                ...
                                                                                <?php if($rating->updated_at && $rating->updated_at->gt($rating->created_at)): ?>
                                                                                    <span class="text-muted">(edited
                                                                                        <?php echo e($rating->updated_at->format('d M')); ?>)</span>
                                                                                <?php endif; ?>
                                                                            </small>
                                                        ...
                                                        <div class="modal fade" id="editReviewModal-<?php echo e($rating->id); ?>"
                                                            tabindex="-1">
                                                            <div class="modal-dialog modal-dialog-centered">
                                                                <div class="modal-content border-0 shadow-sm rounded-3">
                                                                    ...
                                                                    <form method="POST"
                                                                        action="<?php echo e(route('user.account.reviews.update', $rating->id)); ?>">
                                                                        <?php echo csrf_field(); ?>
                                                                        <?php echo method_field('PUT'); ?>
                                                                        ...
                                                                        <div class="modal-body p-4">
                                                                            ...
                                                                            <div class="mb-3">
                                                                                ...
                                                                                <select name="rating"
                                                                                    class="form-select">
                                                                                    <option value="5"
                                                                                        <?php echo e($rating->rating == 5 ? 'selected' : ''); ?>>
                                                                                        5 - Excellent</option>
                                                                                    <option value="4"
                                                                                        <?php echo e($rating->rating == 4 ? 'selected' : ''); ?>>
                                                                                        4 - Very Good</option>
                                                                                    <option value="3"
                                                                                        <?php echo e($rating->rating == 3 ? 'selected' : ''); ?>>
                                                                                        3 - Average</option>
                                                                                    <option value="2"
                                                                                        <?php echo e($rating->rating == 2 ? 'selected' : ''); ?>>
                                                                                        2 - Poor</option>
                                                                                    <option value="1"
                                                                                        <?php echo e($rating->rating == 1 ? 'selected' : ''); ?>>
                                                                                        1 - Terrible</option>
                                                                                </select>
                                                                            </div>
                                                                            ...
                                                                            <div class="mb-3">
                                                                                <label class="form-label">Your
                                                                                    Review</label>
                                                                                <textarea class="form-control" name="review_text" rows="4" required><?php echo e($rating->review_text); ?></textarea>
                                                                            </div>
                                                                        </div>
...
<?php echo $__env->make('layouts_lp.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\ebook_traveling\resources\views\page-account.blade.php ENDPATH**/ ?>