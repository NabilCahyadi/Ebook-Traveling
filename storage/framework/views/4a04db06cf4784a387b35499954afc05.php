        ...
        <div class="mb-4">
            <h4 class="fw-bold py-3 mb-2">
                <span class="text-muted fw-light">
                    <a href="<?php echo e(route('admin.about-us.index')); ?>" class="text-muted">Website Management / About Us</a> /
                </span>
                Tambah Baru
            </h4>
        </div>
        ...
        <div class="row">
            <div class="col-md-8">
                <div class="card">
                    ...
                    <div class="card-body">
                        <form action="<?php echo e(route('admin.about-us.store')); ?>" method="POST">
                            <?php echo csrf_field(); ?>
...
unset($__errorArgs, $__bag); ?>
                            ...
                            <div class="d-flex justify-content-between">
                                <a href="<?php echo e(route('admin.about-us.index')); ?>" class="btn btn-label-secondary">
