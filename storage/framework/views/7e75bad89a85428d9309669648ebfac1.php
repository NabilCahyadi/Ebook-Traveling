...
<head>
    ...
    <title><?php echo e($ebook->title); ?> - Reader</title>
    <!-- PDF.js CSS -->
    ...
    <style>
        ...
        #watermark-bg {
            ...
            background-image: url('data:image/svg+xml;base64,<?php echo e(base64_encode(' <svg xmlns="http://www.w3.org/2000/svg" width="400" height="400" ><text x="50%" y="50%" font-size="30" fill="rgba(255,255,255,0.08)" text-anchor="middle" dominant-baseline="middle" transform="rotate(-45 200 200)" >' . e(Auth::user()->email) . ' </text></svg>')); ?>');
...
<body>
    ...
    <div id="pdf-container">
        ...
        <div id="pdf-canvas-container">
            ...
            <div id="watermark-center">
                ...
                <span style="font-size: 2rem;"><?php echo e(Auth::user()->email); ?></span>
            </div>
    ...
    <script>
        ...
        // --- Logika PDF Viewer ---
        const url = "<?php echo e($ebook->pdf_file_url); ?>"; // Gunakan accessor untuk handle storage path
        let pdfDoc = null,
            pageNum = 1,
            pageRendering = false,
            pageNumPending = null,
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            ...
            const ebookId = "<?php echo e($ebook->id); ?>"; // Sudah benar
            ...
            function sendProgress() {
                fetch('<?php echo e(route("reader.updateProgress")); ?>', {
                        method: 'POST',
                        headers: {
            ...
            window.addEventListener('beforeunload', function(e) {
                ...
                navigator.sendBeacon('<?php echo e(route("reader.updateProgress")); ?>', JSON.stringify({
                    ebook_id: ebookId,
                    last_page: currentPage
                }));
            });
    ...
    <script>
        ...
        // --- Variabel Utama ---
        const url = "<?php echo e($ebook->pdf_file_url); ?>";
        let pdfDoc = null,
            pageNum = 1,
            pageRendering = false,
            pageNumPending = null,
        ...
        const ebookId = "<?php echo e($ebook->id); ?>";
        const updateUrl = '<?php echo e(route("reader.updateProgress")); ?>';
...
</html><?php /**PATH C:\laragon\www\ebook_traveling\resources\views/reader.blade.php ENDPATH**/ ?>